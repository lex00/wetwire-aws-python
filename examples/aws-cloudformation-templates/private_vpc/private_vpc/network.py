"""Network resources: VPC, DummyTargetGroupPrivate, EcsHostSecurityGroup, PrivateLoadBalancerSG, PrivateLoadBalancerIngressFromECS, InternetGateway, GatewayAttachement, NatGatewayTwoAttachment, PublicSubnetTwo, NatGatewayTwo, PrivateRouteTableTwo, PrivateRouteTwo, PrivateRouteTableOne, DummyTargetGroupPublic, PublicSubnetOne, PublicLoadBalancerSG, PublicLoadBalancer, PublicLoadBalancerListener, PublicRouteTable, PublicSubnetTwoRouteTableAssociation, PrivateSubnetTwo, PrivateSubnetOne, PrivateLoadBalancer, PrivateLoadBalancerListener, DynamoDBEndpoint, PublicSubnetOneRouteTableAssociation, PublicRoute, EcsSecurityGroupIngressFromPublicALB, PrivateRouteTableTwoAssociation, NatGatewayOneAttachment, NatGatewayOne, PrivateRouteOne, EcsSecurityGroupIngressFromPrivateALB, PrivateRouteTableOneAssociation, EcsSecurityGroupIngressFromSelf."""
