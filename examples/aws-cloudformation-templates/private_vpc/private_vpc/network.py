"""Network resources: VPC, EcsHostSecurityGroup, PublicLoadBalancerSG, PrivateRouteTableTwo, InternetGateway, GatewayAttachement, NatGatewayTwoAttachment, PublicSubnetTwo, NatGatewayTwo, PrivateRouteTwo, DummyTargetGroupPublic, PrivateRouteTableOne, DynamoDBEndpoint, PrivateSubnetTwo, PrivateRouteTableTwoAssociation, EcsSecurityGroupIngressFromPublicALB, PublicRouteTable, PublicSubnetTwoRouteTableAssociation, PrivateSubnetOne, PrivateLoadBalancerSG, PrivateLoadBalancer, EcsSecurityGroupIngressFromPrivateALB, PublicSubnetOne, PublicLoadBalancer, PublicLoadBalancerListener, PublicSubnetOneRouteTableAssociation, DummyTargetGroupPrivate, PrivateLoadBalancerListener, PrivateLoadBalancerIngressFromECS, PrivateRouteTableOneAssociation, EcsSecurityGroupIngressFromSelf, NatGatewayOneAttachment, NatGatewayOne, PrivateRouteOne, PublicRoute."""
