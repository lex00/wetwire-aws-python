"""Network resources: InternetGateway, VPC, GatewayAttachement, NatGatewayTwoAttachment, NatGatewayOneAttachment, PublicSubnetOne, NatGatewayOne, PublicRouteTable, PublicSubnetOneRouteTableAssociation, PrivateRouteTableTwo, PrivateSubnetTwo, PrivateRouteTableTwoAssociation, PrivateSubnetOne, PrivateLoadBalancerSG, PrivateLoadBalancer, EcsHostSecurityGroup, EcsSecurityGroupIngressFromPrivateALB, DummyTargetGroupPublic, PublicSubnetTwo, NatGatewayTwo, PrivateRouteTableOne, PublicLoadBalancerSG, PrivateRouteTwo, EcsSecurityGroupIngressFromSelf, EcsSecurityGroupIngressFromPublicALB, DummyTargetGroupPrivate, PrivateLoadBalancerListener, PublicSubnetTwoRouteTableAssociation, PrivateLoadBalancerIngressFromECS, PublicLoadBalancer, DynamoDBEndpoint, PrivateRouteTableOneAssociation, PrivateRouteOne, PublicRoute, PublicLoadBalancerListener."""
