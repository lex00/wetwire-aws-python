"""Network resources: VPC, PublicSubnetOne, InternetGateway, GatewayAttachement, NatGatewayOneAttachment, NatGatewayOne, DummyTargetGroupPrivate, EcsHostSecurityGroup, NatGatewayTwoAttachment, PublicRouteTable, PrivateLoadBalancerSG, PrivateSubnetOne, PrivateSubnetTwo, PrivateLoadBalancer, PrivateRouteTableOne, PublicLoadBalancerSG, PublicSubnetTwo, PublicLoadBalancer, DummyTargetGroupPublic, PublicLoadBalancerListener, PublicSubnetOneRouteTableAssociation, PublicSubnetTwoRouteTableAssociation, PrivateRouteTableOneAssociation, NatGatewayTwo, PrivateRouteTableTwo, DynamoDBEndpoint, EcsSecurityGroupIngressFromPublicALB, PrivateRouteTwo, PrivateRouteOne, PrivateLoadBalancerListener, EcsSecurityGroupIngressFromSelf, PrivateLoadBalancerIngressFromECS, PublicRoute, EcsSecurityGroupIngressFromPrivateALB, PrivateRouteTableTwoAssociation."""
