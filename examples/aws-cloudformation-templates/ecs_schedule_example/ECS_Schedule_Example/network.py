"""Network resources: EcsSecurityGroup, ECSALB, ECSTG, EcsSecurityGroupHTTPinbound, ALBListener, ECSALBListenerRule, EcsSecurityGroupALBports, EcsSecurityGroupSSHinbound."""
