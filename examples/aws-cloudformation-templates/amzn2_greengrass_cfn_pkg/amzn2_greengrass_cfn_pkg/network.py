"""Network resources: VPC, InstanceSecurityGroup, RouteTablePublic, InternetGateway, VPCGatewayAttachment, RouteTablePublicInternetRoute, RouteTableAssociationAPublic."""
