"""Compute resources: JwtResourceHandler, JwtResourceRootPermission, TestResourceHandler, TestResourcePermission, JwtResourcePermission, TestResourceRootPermission."""
