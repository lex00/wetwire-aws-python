"""Compute resources: TestResourceHandler, TestResourcePermission, JwtResourceHandler, JwtResourcePermission, JwtResourceRootPermission, TestResourceRootPermission."""
