"""Compute resources: JwtResourceHandler, JwtResourcePermission, TestResourceHandler, TestResourceRootPermission, TestResourcePermission, JwtResourceRootPermission."""
