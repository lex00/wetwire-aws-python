"""Compute resources: TestResourceHandler, JwtResourceHandler, JwtResourceRootPermission, TestResourceRootPermission, JwtResourcePermission, TestResourcePermission."""
