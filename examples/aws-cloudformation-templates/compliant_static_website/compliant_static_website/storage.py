"""Storage resources: CloudFrontLogsReplicaBucket, ContentLogBucket, ContentReplicaBucket, ContentBucket, ContentLogBucketPolicyPolicy, CloudFrontLogsLogBucket, CloudFrontLogsBucket, CloudFrontLogsBucketPolicyPolicy, ContentBucketPolicyPolicy, CloudFrontLogsLogBucketPolicyPolicy, ContentReplicaBucketPolicyPolicy, CloudFrontLogsReplicaBucketPolicyPolicy."""
...
class CloudFrontLogsReplicaBucketMetricsConfiguration:
...
class CloudFrontLogsReplicaBucket:
    ...
    versioning_configuration = CloudFrontLogsReplicaBucketMetricsConfiguration
...
class ContentLogBucketMetricsConfiguration:
    resource: s3tables.TableBucket.MetricsConfiguration
    status = s3.BucketVersioningStatus.ENABLED
...
class ContentLogBucket:
    ...
    versioning_configuration = ContentLogBucketMetricsConfiguration
...
class ContentReplicaBucketMetricsConfiguration:
    resource: s3tables.TableBucket.MetricsConfiguration
    status = s3.BucketVersioningStatus.ENABLED
...
class ContentReplicaBucket:
    ...
    versioning_configuration = ContentReplicaBucketMetricsConfiguration
...
class ContentBucketMetricsConfiguration:
    resource: s3tables.TableBucket.MetricsConfiguration
    status = s3.BucketVersioningStatus.ENABLED
...
class ContentBucket:
    ...
    versioning_configuration = ContentBucketMetricsConfiguration
...
class CloudFrontLogsLogBucketMetricsConfiguration:
    resource: s3tables.TableBucket.MetricsConfiguration
    status = s3.BucketVersioningStatus.ENABLED
...
class CloudFrontLogsLogBucket:
    ...
    versioning_configuration = CloudFrontLogsLogBucketMetricsConfiguration
...
class CloudFrontLogsBucketMetricsConfiguration:
    resource: s3tables.TableBucket.MetricsConfiguration
    status = s3.BucketVersioningStatus.ENABLED
...
class CloudFrontLogsBucket:
    ...
    versioning_configuration = CloudFrontLogsBucketMetricsConfiguration
