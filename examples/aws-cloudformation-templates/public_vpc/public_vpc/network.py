"""Network resources: VPC, PublicSubnetOne, EcsHostSecurityGroup, PublicSubnetTwo, PublicLoadBalancerSG, PublicLoadBalancer, InternetGateway, GatewayAttachement, PublicRouteTable, PublicSubnetOneRouteTableAssociation, EcsSecurityGroupIngressFromSelf, EcsSecurityGroupIngressFromPublicALB, PublicRoute, DummyTargetGroupPublic, PublicLoadBalancerListener, PublicSubnetTwoRouteTableAssociation."""
