"""Network resources: VPC, EcsHostSecurityGroup, InternetGateway, GatewayAttachement, PublicSubnetOne, NatGatewayOneAttachment, NatGatewayOne, PrivateRouteTableOne, PrivateRouteTableTwo, DynamoDBEndpoint, PublicSubnetTwo, PublicLoadBalancerSG, PublicLoadBalancer, DummyTargetGroupPrivate, PrivateSubnetTwo, NatGatewayTwoAttachment, NatGatewayTwo, PrivateRouteTwo, PrivateSubnetOne, PrivateLoadBalancerSG, PrivateLoadBalancer, PublicRouteTable, PublicSubnetOneRouteTableAssociation, PrivateRouteTableOneAssociation, PrivateLoadBalancerListener, PrivateRouteTableTwoAssociation, DummyTargetGroupPublic, PublicLoadBalancerListener, PrivateRouteOne, EcsSecurityGroupIngressFromPrivateALB, EcsSecurityGroupIngressFromPublicALB, PublicRoute, PublicSubnetTwoRouteTableAssociation, EcsSecurityGroupIngressFromSelf, PrivateLoadBalancerIngressFromECS."""
