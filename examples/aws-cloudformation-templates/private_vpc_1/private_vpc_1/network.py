"""Network resources: VPC, PrivateLoadBalancerSG, PrivateSubnetTwo, PrivateSubnetOne, PrivateLoadBalancer, PublicSubnetTwo, PublicRouteTable, PublicSubnetTwoRouteTableAssociation, PublicSubnetOne, PublicSubnetOneRouteTableAssociation, DummyTargetGroupPublic, PublicLoadBalancerSG, PublicLoadBalancer, PublicLoadBalancerListener, DummyTargetGroupPrivate, PrivateLoadBalancerListener, EcsHostSecurityGroup, InternetGateway, GatewayAttachement, NatGatewayTwoAttachment, NatGatewayTwo, EcsSecurityGroupIngressFromPrivateALB, PrivateRouteTableTwo, PrivateRouteTableTwoAssociation, NatGatewayOneAttachment, NatGatewayOne, PrivateRouteTableOne, PrivateRouteTableOneAssociation, EcsSecurityGroupIngressFromPublicALB, PrivateRouteOne, DynamoDBEndpoint, PrivateLoadBalancerIngressFromECS, PublicRoute, EcsSecurityGroupIngressFromSelf, PrivateRouteTwo."""
