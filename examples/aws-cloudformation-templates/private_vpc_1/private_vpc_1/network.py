"""Network resources: VPC, PublicLoadBalancerSG, InternetGateway, EcsHostSecurityGroup, EcsSecurityGroupIngressFromPublicALB, PrivateRouteTableTwo, PublicSubnetTwo, GatewayAttachement, NatGatewayTwoAttachment, NatGatewayTwo, PrivateRouteTwo, PrivateSubnetOne, PrivateSubnetTwo, NatGatewayOneAttachment, PrivateRouteTableTwoAssociation, DummyTargetGroupPublic, PublicSubnetOne, PublicLoadBalancer, PublicLoadBalancerListener, PublicRouteTable, PublicSubnetTwoRouteTableAssociation, PrivateLoadBalancerSG, PrivateLoadBalancerIngressFromECS, NatGatewayOne, PrivateRouteTableOne, PrivateRouteTableOneAssociation, EcsSecurityGroupIngressFromSelf, DynamoDBEndpoint, PublicSubnetOneRouteTableAssociation, PublicRoute, PrivateRouteOne, DummyTargetGroupPrivate, PrivateLoadBalancer, PrivateLoadBalancerListener, EcsSecurityGroupIngressFromPrivateALB."""
