"""Network resources: VPC, PublicSubnetTwo, InternetGateway, GatewayAttachement, NatGatewayTwoAttachment, NatGatewayTwo, PublicRouteTable, PublicSubnetTwoRouteTableAssociation, PrivateRouteTableOne, PublicSubnetOne, NatGatewayOneAttachment, NatGatewayOne, PrivateRouteOne, PrivateRouteTableTwo, PrivateRouteTwo, DummyTargetGroupPublic, PrivateSubnetTwo, PrivateSubnetOne, PrivateLoadBalancerSG, PrivateLoadBalancer, DummyTargetGroupPrivate, PrivateLoadBalancerListener, EcsHostSecurityGroup, PrivateLoadBalancerIngressFromECS, PublicLoadBalancerSG, PublicLoadBalancer, PublicRoute, PublicLoadBalancerListener, PrivateRouteTableOneAssociation, DynamoDBEndpoint, EcsSecurityGroupIngressFromPublicALB, EcsSecurityGroupIngressFromPrivateALB, EcsSecurityGroupIngressFromSelf, PublicSubnetOneRouteTableAssociation, PrivateRouteTableTwoAssociation."""
