"""Network resources: VPC, InternetGateway, GatewayAttachement, NatGatewayTwoAttachment, PublicSubnetTwo, NatGatewayTwo, EcsHostSecurityGroup, EcsSecurityGroupIngressFromSelf, PrivateSubnetOne, PrivateSubnetTwo, PublicSubnetOne, NatGatewayOneAttachment, NatGatewayOne, PrivateRouteTableOne, PrivateRouteOne, DummyTargetGroupPrivate, PrivateRouteTableTwo, PublicRouteTable, PublicSubnetTwoRouteTableAssociation, PublicLoadBalancerSG, PrivateLoadBalancerSG, PrivateLoadBalancerIngressFromECS, PrivateRouteTableOneAssociation, EcsSecurityGroupIngressFromPublicALB, EcsSecurityGroupIngressFromPrivateALB, PublicLoadBalancer, DummyTargetGroupPublic, PublicLoadBalancerListener, PrivateRouteTableTwoAssociation, DynamoDBEndpoint, PublicRoute, PrivateLoadBalancer, PrivateLoadBalancerListener, PublicSubnetOneRouteTableAssociation, PrivateRouteTwo."""
