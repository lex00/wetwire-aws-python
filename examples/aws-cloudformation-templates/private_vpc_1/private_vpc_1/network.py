"""Network resources: VPC, PublicSubnetOne, PrivateLoadBalancerSG, DummyTargetGroupPrivate, PrivateSubnetOne, PublicLoadBalancerSG, PublicSubnetTwo, PublicLoadBalancer, DummyTargetGroupPublic, PublicLoadBalancerListener, PrivateRouteTableTwo, PrivateRouteTableOne, DynamoDBEndpoint, InternetGateway, GatewayAttachement, NatGatewayTwoAttachment, NatGatewayTwo, PrivateRouteTwo, PrivateSubnetTwo, PrivateRouteTableTwoAssociation, EcsHostSecurityGroup, EcsSecurityGroupIngressFromPublicALB, PublicRouteTable, PublicSubnetOneRouteTableAssociation, PrivateLoadBalancerIngressFromECS, EcsSecurityGroupIngressFromSelf, PublicSubnetTwoRouteTableAssociation, NatGatewayOneAttachment, NatGatewayOne, PrivateRouteOne, PrivateLoadBalancer, PublicRoute, PrivateLoadBalancerListener, EcsSecurityGroupIngressFromPrivateALB, PrivateRouteTableOneAssociation."""
