"""Network resources: InternetGateway, VPC, FargateContainerSecurityGroup, PublicLoadBalancerSG, EcsSecurityGroupIngressFromPublicALB, PublicSubnetTwo, PublicRouteTable, PublicSubnetTwoRouteTableAssociation, GatewayAttachement, PublicRoute, PublicSubnetOne, PublicLoadBalancer, DummyTargetGroupPublic, PublicLoadBalancerListener, PublicSubnetOneRouteTableAssociation, EcsSecurityGroupIngressFromSelf."""
