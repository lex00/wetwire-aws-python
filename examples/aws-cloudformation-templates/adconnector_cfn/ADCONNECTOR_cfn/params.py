...
class ADConnectorDescription(Parameter):
...
class ADConnectorSize(Parameter):
...
class CreateDHCPOptionSet(Parameter):
...
class CreateADConnectorDomainMembersSG(Parameter):
...
class CreateLinuxEC2DomainJoinResources(Parameter):
...
class CreateWindowsEC2DomainJoinResources(Parameter):
...
class DomainDNSServers(Parameter):
...
class DomainNetBiosName(Parameter):
...
class DomainJoinUser(Parameter):
...
class DomainJoinUserPassword(Parameter):
...
class SecretsManagerDomainCredentialsSecretsKMSKey(Parameter):
...
class DHCPOptionSetConditionCondition(TemplateCondition):
    logical_id = 'DHCPOptionSetCondition'
    expression = Equals(CreateDHCPOptionSet, 'Yes')


class DomainMembersSGConditionCondition(TemplateCondition):
...
class LinuxEC2DomainJoinResourcesConditionCondition(TemplateCondition):
    logical_id = 'LinuxEC2DomainJoinResourcesCondition'
    expression = Equals(CreateLinuxEC2DomainJoinResources, 'Yes')


class SecretsManagerDomainCredentialsSecretsKMSKeyConditionCondition(TemplateCondition):
...
class SSMLogsBucketNameConditionCondition(TemplateCondition):
    logical_id = 'SSMLogsBucketNameCondition'
    expression = Not(Equals(SSMLogsBucketName, ''))


class WindowsEC2DomainJoinResourcesConditionCondition(TemplateCondition):
