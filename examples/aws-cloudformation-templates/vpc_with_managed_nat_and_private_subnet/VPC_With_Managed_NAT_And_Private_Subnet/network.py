"""Network resources: ElasticIP0, VPC, PrivateSubnet1, PrivateRouteTable1, PrivateSubnet0, PublicSubnet1, ElasticIP1, NATGateway1, PrivateRouteToInternet1, PublicNetworkAcl, PublicSubnet0, PublicSubnetNetworkAclAssociation0, PublicSubnetNetworkAclAssociation1, PrivateRouteTable0, PrivateSubnetRouteTableAssociation0, PrivateSubnetRouteTableAssociation1, PublicRouteTable, NATGateway0, PrivateRouteToInternet0, InboundHTTPPublicNetworkAclEntry, InternetGateway, GatewayToInternet, PublicRoute, PublicSubnetRouteTableAssociation0, PublicSubnetRouteTableAssociation1, OutboundPublicNetworkAclEntry."""
...
class InboundHTTPPublicNetworkAclEntryPortRange:
    resource: ec2.NetworkInsightsAnalysis.PortRange
    from_ = '0'
    to = '65535'
