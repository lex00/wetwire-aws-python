"""Network resources: VPC, DBSubnet1, DBSubnet2, AuroraSecurityGroup, DMSSecurityGroup, RouteTable, SubnetRouteTableAssociation, InternetGateway, AttachGateway, Route, SubnetRouteTableAssociation1."""
