"""Network resources: VPC, PublicSubnetOne, InternetGateway, GatewayAttachement, NatGatewayTwoAttachment, PrivateLoadBalancerSG, NatGatewayOneAttachment, NatGatewayOne, PrivateRouteTableOne, PublicSubnetTwo, NatGatewayTwo, PublicLoadBalancerSG, PublicLoadBalancer, DummyTargetGroupPublic, PublicLoadBalancerListener, PrivateSubnetTwo, DummyTargetGroupPrivate, FargateContainerSecurityGroup, EcsSecurityGroupIngressFromPrivateALB, PrivateSubnetOne, PrivateRouteTableOneAssociation, PrivateLoadBalancer, PrivateLoadBalancerListener, PrivateRouteTableTwo, PrivateRouteTableTwoAssociation, PrivateRouteOne, PrivateRouteTwo, PublicRouteTable, PublicSubnetTwoRouteTableAssociation, EcsSecurityGroupIngressFromPublicALB, PublicRoute, DynamoDBEndpoint, PrivateLoadBalancerIngressFromECS, PublicSubnetOneRouteTableAssociation, EcsSecurityGroupIngressFromSelf."""
