"""Network resources: VPC, FargateContainerSecurityGroup, EcsSecurityGroupIngressFromSelf, DummyTargetGroupPublic, InternetGateway, PrivateSubnetTwo, PrivateSubnetOne, PrivateLoadBalancerSG, PrivateLoadBalancer, PublicLoadBalancerSG, EcsSecurityGroupIngressFromPublicALB, GatewayAttachement, NatGatewayOneAttachment, PublicSubnetOne, NatGatewayOne, PrivateRouteTableTwo, PrivateRouteTableOne, DynamoDBEndpoint, PublicSubnetTwo, PublicLoadBalancer, PublicRouteTable, NatGatewayTwoAttachment, NatGatewayTwo, PrivateRouteTwo, DummyTargetGroupPrivate, PrivateLoadBalancerListener, PrivateRouteOne, PrivateRouteTableOneAssociation, PrivateLoadBalancerIngressFromECS, PrivateRouteTableTwoAssociation, PublicRoute, PublicSubnetOneRouteTableAssociation, PublicSubnetTwoRouteTableAssociation, EcsSecurityGroupIngressFromPrivateALB, PublicLoadBalancerListener."""
