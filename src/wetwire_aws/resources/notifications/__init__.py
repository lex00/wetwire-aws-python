...
class ChannelAssociation(CloudFormationResource):
    ...
    notification_configuration_arn: DslValue[str] | None = None
...
class EventRule(CloudFormationResource):
    ...
    EventRuleStatusSummary = PropertyTypeDescriptor(
...
class ManagedNotificationAccountContactAssociation(CloudFormationResource):
    ...
    contact_identifier: DslValue[str] | None = None
    managed_notification_configuration_arn: DslValue[str] | None = None
...
class NotificationConfiguration(CloudFormationResource):
    ...
    aggregation_duration: DslValue[str] | None = None
...
class NotificationHub(CloudFormationResource):
    ...
    # PropertyType descriptors for nested GetAtt support
    NotificationHubStatusSummary = PropertyTypeDescriptor(
...
class OrganizationalUnitAssociation(CloudFormationResource):
    ...
    notification_configuration_arn: DslValue[str] | None = None
    organizational_unit_id: DslValue[str] | None = None
