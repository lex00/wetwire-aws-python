...
Fleet.AcceleratorCapabilities = _Fleet.AcceleratorCapabilities
Fleet.AcceleratorCountRange = _Fleet.AcceleratorCountRange
Fleet.AcceleratorSelection = _Fleet.AcceleratorSelection
Fleet.AcceleratorTotalMemoryMiBRange = _Fleet.AcceleratorTotalMemoryMiBRange
Fleet.CustomerManagedFleetConfiguration = _Fleet.CustomerManagedFleetConfiguration
Fleet.CustomerManagedWorkerCapabilities = _Fleet.CustomerManagedWorkerCapabilities
Fleet.Ec2EbsVolume = _Fleet.Ec2EbsVolume
Fleet.FleetAmountCapability = _Fleet.FleetAmountCapability
Fleet.FleetAttributeCapability = _Fleet.FleetAttributeCapability
Fleet.FleetCapabilities = _Fleet.FleetCapabilities
Fleet.FleetConfiguration = _Fleet.FleetConfiguration
Fleet.HostConfiguration = _Fleet.HostConfiguration
Fleet.MemoryMiBRange = _Fleet.MemoryMiBRange
Fleet.ServiceManagedEc2FleetConfiguration = _Fleet.ServiceManagedEc2FleetConfiguration
Fleet.ServiceManagedEc2InstanceCapabilities = (
    _Fleet.ServiceManagedEc2InstanceCapabilities
)
Fleet.ServiceManagedEc2InstanceMarketOptions = (
    _Fleet.ServiceManagedEc2InstanceMarketOptions
)
Fleet.VCpuCountRange = _Fleet.VCpuCountRange
Fleet.VpcConfiguration = _Fleet.VpcConfiguration
Queue.JobAttachmentSettings = _Queue.JobAttachmentSettings
Queue.JobRunAsUser = _Queue.JobRunAsUser
Queue.PosixUser = _Queue.PosixUser
Queue.WindowsUser = _Queue.WindowsUser
StorageProfile.FileSystemLocation = _StorageProfile.FileSystemLocation
