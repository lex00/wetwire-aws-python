...
class AssessmentTarget(CloudFormationResource):
    ...
    assessment_target_name: DslValue[str] | None = None
    resource_group_arn: DslValue[str] | None = None
...
class AssessmentTemplate(CloudFormationResource):
    ...
    assessment_target_arn: DslValue[str] | None = None
    duration_in_seconds: DslValue[int] | None = None
    rules_package_arns: list[DslValue[str]] = field(default_factory=list)
    assessment_template_name: DslValue[str] | None = None
    user_attributes_for_findings: list[DslValue[Tag]] = field(default_factory=list)
...
class ResourceGroup(CloudFormationResource):
    ...
    resource_group_tags: list[DslValue[Tag]] = field(default_factory=list)
