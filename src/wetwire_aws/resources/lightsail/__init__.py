...
Bucket.AccessRules = PropertyTypeDescriptor(_Bucket.AccessRules, "AccessRules")
Container.Container = PropertyTypeDescriptor(_Container.Container, "Container")
Container.ContainerServiceDeployment = PropertyTypeDescriptor(
    _Container.ContainerServiceDeployment, "ContainerServiceDeployment"
)
Container.EcrImagePullerRole = PropertyTypeDescriptor(
    _Container.EcrImagePullerRole, "EcrImagePullerRole"
)
Container.EnvironmentVariable = PropertyTypeDescriptor(
    _Container.EnvironmentVariable, "EnvironmentVariable"
)
Container.HealthCheckConfig = PropertyTypeDescriptor(
    _Container.HealthCheckConfig, "HealthCheckConfig"
)
Container.PortInfo = PropertyTypeDescriptor(_Container.PortInfo, "PortInfo")
Container.PrivateRegistryAccess = PropertyTypeDescriptor(
    _Container.PrivateRegistryAccess, "PrivateRegistryAccess"
)
Container.PublicDomainName = PropertyTypeDescriptor(
    _Container.PublicDomainName, "PublicDomainName"
)
Container.PublicEndpoint = PropertyTypeDescriptor(
    _Container.PublicEndpoint, "PublicEndpoint"
)
Database.RelationalDatabaseParameter = PropertyTypeDescriptor(
    _Database.RelationalDatabaseParameter, "RelationalDatabaseParameter"
)
Disk.AddOn = PropertyTypeDescriptor(_Disk.AddOn, "AddOn")
Disk.AutoSnapshotAddOn = PropertyTypeDescriptor(
    _Disk.AutoSnapshotAddOn, "AutoSnapshotAddOn"
)
Disk.Location = PropertyTypeDescriptor(_Disk.Location, "Location")
DiskSnapshot.Location = PropertyTypeDescriptor(_DiskSnapshot.Location, "Location")
Distribution.CacheBehavior = PropertyTypeDescriptor(
    _Distribution.CacheBehavior, "CacheBehavior"
)
Distribution.CacheBehaviorPerPath = PropertyTypeDescriptor(
    _Distribution.CacheBehaviorPerPath, "CacheBehaviorPerPath"
)
Distribution.CacheSettings = PropertyTypeDescriptor(
    _Distribution.CacheSettings, "CacheSettings"
)
Distribution.CookieObject = PropertyTypeDescriptor(
    _Distribution.CookieObject, "CookieObject"
)
Distribution.HeaderObject = PropertyTypeDescriptor(
    _Distribution.HeaderObject, "HeaderObject"
)
Distribution.InputOrigin = PropertyTypeDescriptor(
    _Distribution.InputOrigin, "InputOrigin"
)
Distribution.QueryStringObject = PropertyTypeDescriptor(
    _Distribution.QueryStringObject, "QueryStringObject"
)
Domain.DomainEntry = PropertyTypeDescriptor(_Domain.DomainEntry, "DomainEntry")
Domain.Location = PropertyTypeDescriptor(_Domain.Location, "Location")
Instance.AddOn = PropertyTypeDescriptor(_Instance.AddOn, "AddOn")
Instance.AutoSnapshotAddOn = PropertyTypeDescriptor(
    _Instance.AutoSnapshotAddOn, "AutoSnapshotAddOn"
)
Instance.Disk = PropertyTypeDescriptor(_Instance.Disk, "Disk")
Instance.Hardware = PropertyTypeDescriptor(_Instance.Hardware, "Hardware")
Instance.Location = PropertyTypeDescriptor(_Instance.Location, "Location")
Instance.MonthlyTransfer = PropertyTypeDescriptor(
    _Instance.MonthlyTransfer, "MonthlyTransfer"
)
Instance.Networking = PropertyTypeDescriptor(_Instance.Networking, "Networking")
Instance.Port = PropertyTypeDescriptor(_Instance.Port, "Port")
Instance.State = PropertyTypeDescriptor(_Instance.State, "State")
InstanceSnapshot.Location = PropertyTypeDescriptor(
    _InstanceSnapshot.Location, "Location"
)
