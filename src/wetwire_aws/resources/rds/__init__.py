...
DBCluster.DBClusterRole = _DBCluster.DBClusterRole
DBCluster.Endpoint = _DBCluster.Endpoint
DBCluster.MasterUserSecret = _DBCluster.MasterUserSecret
DBCluster.ReadEndpoint = _DBCluster.ReadEndpoint
DBCluster.ScalingConfiguration = _DBCluster.ScalingConfiguration
DBCluster.ServerlessV2ScalingConfiguration = _DBCluster.ServerlessV2ScalingConfiguration
DBInstance.CertificateDetails = _DBInstance.CertificateDetails
DBInstance.DBInstanceRole = _DBInstance.DBInstanceRole
DBInstance.DBInstanceStatusInfo = _DBInstance.DBInstanceStatusInfo
DBInstance.Endpoint = _DBInstance.Endpoint
DBInstance.MasterUserSecret = _DBInstance.MasterUserSecret
DBInstance.ProcessorFeature = _DBInstance.ProcessorFeature
DBProxy.AuthFormat = _DBProxy.AuthFormat
DBProxy.TagFormat = _DBProxy.TagFormat
DBProxyEndpoint.TagFormat = _DBProxyEndpoint.TagFormat
DBProxyTargetGroup.ConnectionPoolConfigurationInfoFormat = (
    _DBProxyTargetGroup.ConnectionPoolConfigurationInfoFormat
)
DBSecurityGroup.Ingress = _DBSecurityGroup.Ingress
GlobalCluster.GlobalEndpoint = _GlobalCluster.GlobalEndpoint
OptionGroup.OptionConfiguration = _OptionGroup.OptionConfiguration
OptionGroup.OptionSetting = _OptionGroup.OptionSetting
