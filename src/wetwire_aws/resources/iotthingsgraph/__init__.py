...
class FlowTemplate(CloudFormationResource):
    ...
    definition: DslValue[_FlowTemplate.DefinitionDocument] | None = None
    compatible_namespace_version: DslValue[float] | None = None

    # PropertyType descriptors for nested GetAtt support
    DefinitionDocument = PropertyTypeDescriptor(
