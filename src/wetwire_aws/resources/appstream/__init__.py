...
AppBlock.S3Location = PropertyTypeDescriptor(_AppBlock.S3Location, "S3Location")
AppBlock.ScriptDetails = PropertyTypeDescriptor(
    _AppBlock.ScriptDetails, "ScriptDetails"
)
AppBlockBuilder.AccessEndpoint = PropertyTypeDescriptor(
    _AppBlockBuilder.AccessEndpoint, "AccessEndpoint"
)
AppBlockBuilder.VpcConfig = PropertyTypeDescriptor(
    _AppBlockBuilder.VpcConfig, "VpcConfig"
)
Application.S3Location = PropertyTypeDescriptor(_Application.S3Location, "S3Location")
DirectoryConfig.CertificateBasedAuthProperties = PropertyTypeDescriptor(
    _DirectoryConfig.CertificateBasedAuthProperties, "CertificateBasedAuthProperties"
)
DirectoryConfig.ServiceAccountCredentials = PropertyTypeDescriptor(
    _DirectoryConfig.ServiceAccountCredentials, "ServiceAccountCredentials"
)
Entitlement.Attribute = PropertyTypeDescriptor(_Entitlement.Attribute, "Attribute")
Fleet.ComputeCapacity = PropertyTypeDescriptor(
    _Fleet.ComputeCapacity, "ComputeCapacity"
)
Fleet.DomainJoinInfo = PropertyTypeDescriptor(_Fleet.DomainJoinInfo, "DomainJoinInfo")
Fleet.S3Location = PropertyTypeDescriptor(_Fleet.S3Location, "S3Location")
Fleet.VpcConfig = PropertyTypeDescriptor(_Fleet.VpcConfig, "VpcConfig")
ImageBuilder.AccessEndpoint = PropertyTypeDescriptor(
    _ImageBuilder.AccessEndpoint, "AccessEndpoint"
)
ImageBuilder.DomainJoinInfo = PropertyTypeDescriptor(
    _ImageBuilder.DomainJoinInfo, "DomainJoinInfo"
)
ImageBuilder.VpcConfig = PropertyTypeDescriptor(_ImageBuilder.VpcConfig, "VpcConfig")
Stack.AccessEndpoint = PropertyTypeDescriptor(_Stack.AccessEndpoint, "AccessEndpoint")
Stack.ApplicationSettings = PropertyTypeDescriptor(
    _Stack.ApplicationSettings, "ApplicationSettings"
)
Stack.StorageConnector = PropertyTypeDescriptor(
    _Stack.StorageConnector, "StorageConnector"
)
Stack.StreamingExperienceSettings = PropertyTypeDescriptor(
    _Stack.StreamingExperienceSettings, "StreamingExperienceSettings"
)
Stack.UserSetting = PropertyTypeDescriptor(_Stack.UserSetting, "UserSetting")
