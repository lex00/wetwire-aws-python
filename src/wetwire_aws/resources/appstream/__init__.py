...
class AppBlock(CloudFormationResource):
    ...
    source_s3_location: DslValue[_AppBlock.S3Location] | None = None
    description: DslValue[str] | None = None
    display_name: DslValue[str] | None = None
    packaging_type: DslValue[str] | None = None
    post_setup_script_details: DslValue[_AppBlock.ScriptDetails] | None = None
    setup_script_details: DslValue[_AppBlock.ScriptDetails] | None = None
    ...
    S3Location = PropertyTypeDescriptor(_AppBlock.S3Location, "S3Location")
    ScriptDetails = PropertyTypeDescriptor(_AppBlock.ScriptDetails, "ScriptDetails")
...
class AppBlockBuilder(CloudFormationResource):
    ...
    vpc_config: DslValue[_AppBlockBuilder.VpcConfig] | None = None
    access_endpoints: list[DslValue[_AppBlockBuilder.AccessEndpoint]] = field(
        default_factory=list
    )
    app_block_arns: list[DslValue[str]] = field(default_factory=list)
    description: DslValue[str] | None = None
    display_name: DslValue[str] | None = None
    enable_default_internet_access: DslValue[bool] | None = None
    ...
    # PropertyType descriptors for nested GetAtt support
    AccessEndpoint = PropertyTypeDescriptor(
        _AppBlockBuilder.AccessEndpoint, "AccessEndpoint"
    )
    VpcConfig = PropertyTypeDescriptor(_AppBlockBuilder.VpcConfig, "VpcConfig")
...
class Application(CloudFormationResource):
    ...
    app_block_arn: DslValue[str] | None = None
    icon_s3_location: DslValue[_Application.S3Location] | None = None
    instance_families: list[DslValue[str]] = field(default_factory=list)
    launch_path: DslValue[str] | None = None
    name: DslValue[str] | None = None
    platforms: list[DslValue[str]] = field(default_factory=list)
    attributes_to_delete: list[DslValue[str]] = field(default_factory=list)
    description: DslValue[str] | None = None
    display_name: DslValue[str] | None = None
    launch_parameters: DslValue[str] | None = None
    tags: list[DslValue[Tag]] = field(default_factory=list)
    ...
    # PropertyType descriptors for nested GetAtt support
    S3Location = PropertyTypeDescriptor(_Application.S3Location, "S3Location")
...
class ApplicationEntitlementAssociation(CloudFormationResource):
    ...
    entitlement_name: DslValue[str] | None = None
    stack_name: DslValue[str] | None = None
...
class ApplicationFleetAssociation(CloudFormationResource):
    ...
    fleet_name: DslValue[str] | None = None
...
class DirectoryConfig(CloudFormationResource):
    ...
    organizational_unit_distinguished_names: list[DslValue[str]] = field(
        default_factory=list
    )
    service_account_credentials: (
        DslValue[_DirectoryConfig.ServiceAccountCredentials] | None
    ) = None
    certificate_based_auth_properties: (
        DslValue[_DirectoryConfig.CertificateBasedAuthProperties] | None
    ) = None

    # PropertyType descriptors for nested GetAtt support
    CertificateBasedAuthProperties = PropertyTypeDescriptor(
        _DirectoryConfig.CertificateBasedAuthProperties,
        "CertificateBasedAuthProperties",
    )
    ServiceAccountCredentials = PropertyTypeDescriptor(
        _DirectoryConfig.ServiceAccountCredentials, "ServiceAccountCredentials"
    )
...
class Entitlement(CloudFormationResource):
    ...
    app_visibility: DslValue[str] | None = None
    attributes: list[DslValue[_Entitlement.Attribute]] = field(default_factory=list)
    name: DslValue[str] | None = None
    stack_name: DslValue[str] | None = None
    description: DslValue[str] | None = None
    ...
    # PropertyType descriptors for nested GetAtt support
    Attribute = PropertyTypeDescriptor(_Entitlement.Attribute, "Attribute")
...
class Fleet(CloudFormationResource):
    ...
    instance_type: DslValue[str] | None = None
    name: DslValue[str] | None = None
    compute_capacity: DslValue[_Fleet.ComputeCapacity] | None = None
    description: DslValue[str] | None = None
    disconnect_timeout_in_seconds: DslValue[int] | None = None
    display_name: DslValue[str] | None = None
    domain_join_info: DslValue[_Fleet.DomainJoinInfo] | None = None
    enable_default_internet_access: DslValue[bool] | None = None
    fleet_type: DslValue[str] | None = None
    iam_role_arn: DslValue[str] | None = None
    idle_disconnect_timeout_in_seconds: DslValue[int] | None = None
    image_arn: DslValue[str] | None = None
    image_name: DslValue[str] | None = None
    max_concurrent_sessions: DslValue[int] | None = None
    max_sessions_per_instance: DslValue[int] | None = None
    max_user_duration_in_seconds: DslValue[int] | None = None
    platform: DslValue[str] | None = None
    session_script_s3_location: DslValue[_Fleet.S3Location] | None = None
    stream_view: DslValue[str] | None = None
    tags: list[DslValue[Tag]] = field(default_factory=list)
    usb_device_filter_strings: list[DslValue[str]] = field(default_factory=list)
    vpc_config: DslValue[_Fleet.VpcConfig] | None = None

    # PropertyType descriptors for nested GetAtt support
    ComputeCapacity = PropertyTypeDescriptor(_Fleet.ComputeCapacity, "ComputeCapacity")
    DomainJoinInfo = PropertyTypeDescriptor(_Fleet.DomainJoinInfo, "DomainJoinInfo")
    S3Location = PropertyTypeDescriptor(_Fleet.S3Location, "S3Location")
...
class ImageBuilder(CloudFormationResource):
    ...
    instance_type: DslValue[str] | None = None
    name: DslValue[str] | None = None
    access_endpoints: list[DslValue[_ImageBuilder.AccessEndpoint]] = field(
        default_factory=list
    )
    appstream_agent_version: DslValue[str] | None = None
    description: DslValue[str] | None = None
    display_name: DslValue[str] | None = None
    domain_join_info: DslValue[_ImageBuilder.DomainJoinInfo] | None = None
    enable_default_internet_access: DslValue[bool] | None = None
    iam_role_arn: DslValue[str] | None = None
    image_arn: DslValue[str] | None = None
    image_name: DslValue[str] | None = None
    tags: list[DslValue[Tag]] = field(default_factory=list)
    vpc_config: DslValue[_ImageBuilder.VpcConfig] | None = None
    ...
    # PropertyType descriptors for nested GetAtt support
    AccessEndpoint = PropertyTypeDescriptor(
        _ImageBuilder.AccessEndpoint, "AccessEndpoint"
    )
    DomainJoinInfo = PropertyTypeDescriptor(
        _ImageBuilder.DomainJoinInfo, "DomainJoinInfo"
    )
    VpcConfig = PropertyTypeDescriptor(_ImageBuilder.VpcConfig, "VpcConfig")
...
class Stack(CloudFormationResource):
    ...
    access_endpoints: list[DslValue[_Stack.AccessEndpoint]] = field(
        default_factory=list
    )
    application_settings: DslValue[_Stack.ApplicationSettings] | None = None
    attributes_to_delete: list[DslValue[str]] = field(default_factory=list)
    delete_storage_connectors: DslValue[bool] | None = None
    description: DslValue[str] | None = None
    display_name: DslValue[str] | None = None
    embed_host_domains: list[DslValue[str]] = field(default_factory=list)
    feedback_url: DslValue[str] | None = None
    name: DslValue[str] | None = None
    redirect_url: DslValue[str] | None = None
    storage_connectors: list[DslValue[_Stack.StorageConnector]] = field(
        default_factory=list
    )
    streaming_experience_settings: (
        DslValue[_Stack.StreamingExperienceSettings] | None
    ) = None
    tags: list[DslValue[Tag]] = field(default_factory=list)
    user_settings: list[DslValue[_Stack.UserSetting]] = field(default_factory=list)

    # PropertyType descriptors for nested GetAtt support
    AccessEndpoint = PropertyTypeDescriptor(_Stack.AccessEndpoint, "AccessEndpoint")
    ApplicationSettings = PropertyTypeDescriptor(
        _Stack.ApplicationSettings, "ApplicationSettings"
    )
    StorageConnector = PropertyTypeDescriptor(
        _Stack.StorageConnector, "StorageConnector"
    )
    StreamingExperienceSettings = PropertyTypeDescriptor(
        _Stack.StreamingExperienceSettings, "StreamingExperienceSettings"
    )
    UserSetting = PropertyTypeDescriptor(_Stack.UserSetting, "UserSetting")
...
class StackUserAssociation(CloudFormationResource):
    ...
    send_email_notification: DslValue[bool] | None = None
