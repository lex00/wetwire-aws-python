...
Dataset.AttributesItems = _Dataset.AttributesItems
Dataset.EncryptionConfig = _Dataset.EncryptionConfig
Dataset.Schema = _Dataset.Schema
Dataset.TagsItems = _Dataset.TagsItems
