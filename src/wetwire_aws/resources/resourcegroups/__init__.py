...
Group.ConfigurationItem = PropertyTypeDescriptor(
    _Group.ConfigurationItem, "ConfigurationItem"
)
Group.ConfigurationParameter = PropertyTypeDescriptor(
    _Group.ConfigurationParameter, "ConfigurationParameter"
)
Group.Query = PropertyTypeDescriptor(_Group.Query, "Query")
Group.ResourceQuery = PropertyTypeDescriptor(_Group.ResourceQuery, "ResourceQuery")
Group.TagFilter = PropertyTypeDescriptor(_Group.TagFilter, "TagFilter")
