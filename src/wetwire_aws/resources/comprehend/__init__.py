...
class DocumentClassifier(CloudFormationResource):
    ...
    data_access_role_arn: DslValue[str] | None = None
    document_classifier_name: DslValue[str] | None = None
    input_data_config: (
        DslValue[_DocumentClassifier.DocumentClassifierInputDataConfig] | None
    ) = None
    language_code: DslValue[str] | None = None
    mode: DslValue[str] | None = None
    model_kms_key_id: DslValue[str] | None = None
    model_policy: DslValue[str] | None = None
    output_data_config: (
        DslValue[_DocumentClassifier.DocumentClassifierOutputDataConfig] | None
    ) = None
...
class Flywheel(CloudFormationResource):
    ...
    data_access_role_arn: DslValue[str] | None = None
    data_lake_s3_uri: DslValue[str] | None = None
    flywheel_name: DslValue[str] | None = None
    active_model_arn: DslValue[str] | None = None
    data_security_config: DslValue[_Flywheel.DataSecurityConfig] | None = None
    model_type: DslValue[str] | None = None
    tags: list[DslValue[Tag]] = field(default_factory=list)
    task_config: DslValue[_Flywheel.TaskConfig] | None = None

    # GetAtt attributes
    ARN: ClassVar[str] = "Arn"

    # PropertyType descriptors for nested GetAtt support
    DataSecurityConfig = PropertyTypeDescriptor(
        _Flywheel.DataSecurityConfig, "DataSecurityConfig"
    )
    DocumentClassificationConfig = PropertyTypeDescriptor(
        _Flywheel.DocumentClassificationConfig, "DocumentClassificationConfig"
    )
    EntityRecognitionConfig = PropertyTypeDescriptor(
        _Flywheel.EntityRecognitionConfig, "EntityRecognitionConfig"
    )
    EntityTypesListItem = PropertyTypeDescriptor(
        _Flywheel.EntityTypesListItem, "EntityTypesListItem"
    )
    TaskConfig = PropertyTypeDescriptor(_Flywheel.TaskConfig, "TaskConfig")
    VpcConfig = PropertyTypeDescriptor(_Flywheel.VpcConfig, "VpcConfig")
