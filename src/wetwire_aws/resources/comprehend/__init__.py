...
DocumentClassifier.AugmentedManifestsListItem = (
    _DocumentClassifier.AugmentedManifestsListItem
)
DocumentClassifier.DocumentClassifierDocuments = (
    _DocumentClassifier.DocumentClassifierDocuments
)
DocumentClassifier.DocumentClassifierInputDataConfig = (
    _DocumentClassifier.DocumentClassifierInputDataConfig
)
DocumentClassifier.DocumentClassifierOutputDataConfig = (
    _DocumentClassifier.DocumentClassifierOutputDataConfig
)
DocumentClassifier.DocumentReaderConfig = _DocumentClassifier.DocumentReaderConfig
DocumentClassifier.VpcConfig = _DocumentClassifier.VpcConfig
Flywheel.DataSecurityConfig = _Flywheel.DataSecurityConfig
Flywheel.DocumentClassificationConfig = _Flywheel.DocumentClassificationConfig
Flywheel.EntityRecognitionConfig = _Flywheel.EntityRecognitionConfig
Flywheel.EntityTypesListItem = _Flywheel.EntityTypesListItem
Flywheel.TaskConfig = _Flywheel.TaskConfig
Flywheel.VpcConfig = _Flywheel.VpcConfig
