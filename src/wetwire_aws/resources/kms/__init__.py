...
class Alias(CloudFormationResource):
    ...
    target_key_id: DslValue[str] | None = None
...
class Key(CloudFormationResource):
    ...
    enable_key_rotation: DslValue[bool] | None = None
    enabled: DslValue[bool] | None = None
    key_policy: DslValue[dict[str, Any]] | None = None
    key_spec: DslValue[str] | None = None
    key_usage: DslValue[str] | None = None
    multi_region: DslValue[bool] | None = None
    origin: DslValue[str] | None = None
    pending_window_in_days: DslValue[int] | None = None
    rotation_period_in_days: DslValue[int] | None = None
...
class ReplicaKey(CloudFormationResource):
    ...
    key_policy: DslValue[dict[str, Any]] | None = None
    primary_key_arn: DslValue[str] | None = None
    description: DslValue[str] | None = None
    enabled: DslValue[bool] | None = None
    pending_window_in_days: DslValue[int] | None = None
    tags: list[DslValue[Tag]] = field(default_factory=list)
