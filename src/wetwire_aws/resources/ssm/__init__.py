...
class Association(CloudFormationResource):
    ...
    apply_only_at_cron_interval: DslValue[bool] | None = None
    association_name: DslValue[str] | None = None
    automation_target_parameter_name: DslValue[str] | None = None
    calendar_names: list[DslValue[str]] = field(default_factory=list)
    compliance_severity: DslValue[str] | None = None
    document_version: DslValue[str] | None = None
    instance_id: DslValue[str] | None = None
    max_concurrency: DslValue[str] | None = None
    max_errors: DslValue[str] | None = None
    output_location: DslValue[_Association.InstanceAssociationOutputLocation] | None = (
        None
    )
    ...
    sync_compliance: DslValue[str] | None = None
    targets: list[DslValue[_Association.Target]] = field(default_factory=list)
    wait_for_success_timeout_seconds: DslValue[int] | None = None

    # GetAtt attributes
    ASSOCIATIONID: ClassVar[str] = "AssociationId"

    # PropertyType descriptors for nested GetAtt support
    InstanceAssociationOutputLocation = PropertyTypeDescriptor(
        _Association.InstanceAssociationOutputLocation,
        "InstanceAssociationOutputLocation",
    )
    S3OutputLocation = PropertyTypeDescriptor(
        _Association.S3OutputLocation, "S3OutputLocation"
    )
    Target = PropertyTypeDescriptor(_Association.Target, "Target")
...
class Document(CloudFormationResource):
    ...
    content: DslValue[dict[str, Any]] | None = None
    attachments: list[DslValue[_Document.AttachmentsSource]] = field(
        default_factory=list
    )
    document_format: DslValue[str] | None = None
    document_type: DslValue[str] | None = None
    name: DslValue[str] | None = None
    requires: list[DslValue[_Document.DocumentRequires]] = field(default_factory=list)
    tags: list[DslValue[Tag]] = field(default_factory=list)
    target_type: DslValue[str] | None = None
    update_method: DslValue[str] | None = None
    version_name: DslValue[str] | None = None

    # PropertyType descriptors for nested GetAtt support
    AttachmentsSource = PropertyTypeDescriptor(
        _Document.AttachmentsSource, "AttachmentsSource"
    )
    DocumentRequires = PropertyTypeDescriptor(
...
class MaintenanceWindow(CloudFormationResource):
    ...
    allow_unassociated_targets: DslValue[bool] | None = None
    cutoff: DslValue[int] | None = None
    ...
    schedule_offset: DslValue[int] | None = None
    schedule_timezone: DslValue[str] | None = None
...
class MaintenanceWindowTarget(CloudFormationResource):
    ...
    targets: list[DslValue[_MaintenanceWindowTarget.Targets]] = field(
        default_factory=list
    )
    window_id: DslValue[str] | None = None
    description: DslValue[str] | None = None
    name: DslValue[str] | None = None
    owner_information: DslValue[str] | None = None

    # GetAtt attributes
    WINDOWTARGETID: ClassVar[str] = "WindowTargetId"

    # PropertyType descriptors for nested GetAtt support
    Targets = PropertyTypeDescriptor(_MaintenanceWindowTarget.Targets, "Targets")
...
class MaintenanceWindowTask(CloudFormationResource):
    ...
    task_arn: DslValue[str] | None = None
    task_type: DslValue[str] | None = None
    window_id: DslValue[str] | None = None
    cutoff_behavior: DslValue[str] | None = None
    description: DslValue[str] | None = None
    logging_info: DslValue[_MaintenanceWindowTask.LoggingInfo] | None = None
    max_concurrency: DslValue[str] | None = None
    max_errors: DslValue[str] | None = None
    name: DslValue[str] | None = None
    service_role_arn: DslValue[str] | None = None
    targets: list[DslValue[_MaintenanceWindowTask.Target]] = field(default_factory=list)
    task_invocation_parameters: (
        DslValue[_MaintenanceWindowTask.TaskInvocationParameters] | None
    ) = None
    task_parameters: DslValue[dict[str, Any]] | None = None

    # GetAtt attributes
    WINDOWTASKID: ClassVar[str] = "WindowTaskId"

    # PropertyType descriptors for nested GetAtt support
    CloudWatchOutputConfig = PropertyTypeDescriptor(
        _MaintenanceWindowTask.CloudWatchOutputConfig, "CloudWatchOutputConfig"
    )
    LoggingInfo = PropertyTypeDescriptor(
        _MaintenanceWindowTask.LoggingInfo, "LoggingInfo"
    )
    MaintenanceWindowAutomationParameters = PropertyTypeDescriptor(
        _MaintenanceWindowTask.MaintenanceWindowAutomationParameters,
        "MaintenanceWindowAutomationParameters",
    )
    MaintenanceWindowLambdaParameters = PropertyTypeDescriptor(
        _MaintenanceWindowTask.MaintenanceWindowLambdaParameters,
        "MaintenanceWindowLambdaParameters",
    )
    MaintenanceWindowRunCommandParameters = PropertyTypeDescriptor(
        _MaintenanceWindowTask.MaintenanceWindowRunCommandParameters,
        "MaintenanceWindowRunCommandParameters",
    )
    MaintenanceWindowStepFunctionsParameters = PropertyTypeDescriptor(
        _MaintenanceWindowTask.MaintenanceWindowStepFunctionsParameters,
        "MaintenanceWindowStepFunctionsParameters",
    )
    NotificationConfig = PropertyTypeDescriptor(
        _MaintenanceWindowTask.NotificationConfig, "NotificationConfig"
    )
    Target = PropertyTypeDescriptor(_MaintenanceWindowTask.Target, "Target")
    TaskInvocationParameters = PropertyTypeDescriptor(
...
class Parameter(CloudFormationResource):
    ...
    allowed_pattern: DslValue[str] | None = None
    data_type: DslValue[str] | None = None
    description: DslValue[str] | None = None
    name: DslValue[str] | None = None
    policies: DslValue[str] | None = None
...
class PatchBaseline(CloudFormationResource):
    ...
    name: DslValue[str] | None = None
    approval_rules: DslValue[_PatchBaseline.RuleGroup] | None = None
    approved_patches: list[DslValue[str]] = field(default_factory=list)
    approved_patches_compliance_level: DslValue[str] | None = None
    approved_patches_enable_non_security: DslValue[bool] | None = None
    available_security_updates_compliance_status: DslValue[str] | None = None
    default_baseline: DslValue[bool] | None = None
    description: DslValue[str] | None = None
    global_filters: DslValue[_PatchBaseline.PatchFilterGroup] | None = None
    operating_system: DslValue[str] | None = None
    patch_groups: list[DslValue[str]] = field(default_factory=list)
    rejected_patches: list[DslValue[str]] = field(default_factory=list)
    rejected_patches_action: DslValue[str] | None = None
    sources: list[DslValue[_PatchBaseline.PatchSource]] = field(default_factory=list)
    tags: list[DslValue[Tag]] = field(default_factory=list)
    ...
    # PropertyType descriptors for nested GetAtt support
    PatchFilter = PropertyTypeDescriptor(_PatchBaseline.PatchFilter, "PatchFilter")
    PatchFilterGroup = PropertyTypeDescriptor(
        _PatchBaseline.PatchFilterGroup, "PatchFilterGroup"
    )
    PatchSource = PropertyTypeDescriptor(_PatchBaseline.PatchSource, "PatchSource")
    Rule = PropertyTypeDescriptor(_PatchBaseline.Rule, "Rule")
    RuleGroup = PropertyTypeDescriptor(_PatchBaseline.RuleGroup, "RuleGroup")
...
class ResourceDataSync(CloudFormationResource):
    ...
    sync_name: DslValue[str] | None = None
    ...
    s3_destination: DslValue[_ResourceDataSync.S3Destination] | None = None
    sync_format: DslValue[str] | None = None
    sync_source: DslValue[_ResourceDataSync.SyncSource] | None = None
    sync_type: DslValue[str] | None = None

    # PropertyType descriptors for nested GetAtt support
    AwsOrganizationsSource = PropertyTypeDescriptor(
        _ResourceDataSync.AwsOrganizationsSource, "AwsOrganizationsSource"
    )
    S3Destination = PropertyTypeDescriptor(
        _ResourceDataSync.S3Destination, "S3Destination"
    )
    SyncSource = PropertyTypeDescriptor(_ResourceDataSync.SyncSource, "SyncSource")
