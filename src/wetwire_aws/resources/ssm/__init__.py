...
Association.S3OutputLocation = _Association.S3OutputLocation
Association.Target = _Association.Target
Document.AttachmentsSource = _Document.AttachmentsSource
Document.DocumentRequires = _Document.DocumentRequires
MaintenanceWindowTarget.Targets = _MaintenanceWindowTarget.Targets
MaintenanceWindowTask.CloudWatchOutputConfig = (
    _MaintenanceWindowTask.CloudWatchOutputConfig
)
MaintenanceWindowTask.LoggingInfo = _MaintenanceWindowTask.LoggingInfo
MaintenanceWindowTask.MaintenanceWindowAutomationParameters = (
    _MaintenanceWindowTask.MaintenanceWindowAutomationParameters
)
MaintenanceWindowTask.MaintenanceWindowLambdaParameters = (
    _MaintenanceWindowTask.MaintenanceWindowLambdaParameters
)
MaintenanceWindowTask.MaintenanceWindowRunCommandParameters = (
    _MaintenanceWindowTask.MaintenanceWindowRunCommandParameters
)
MaintenanceWindowTask.MaintenanceWindowStepFunctionsParameters = (
    _MaintenanceWindowTask.MaintenanceWindowStepFunctionsParameters
)
MaintenanceWindowTask.NotificationConfig = _MaintenanceWindowTask.NotificationConfig
MaintenanceWindowTask.Target = _MaintenanceWindowTask.Target
MaintenanceWindowTask.TaskInvocationParameters = (
    _MaintenanceWindowTask.TaskInvocationParameters
)
PatchBaseline.PatchFilter = _PatchBaseline.PatchFilter
PatchBaseline.PatchFilterGroup = _PatchBaseline.PatchFilterGroup
PatchBaseline.PatchSource = _PatchBaseline.PatchSource
PatchBaseline.Rule = _PatchBaseline.Rule
PatchBaseline.RuleGroup = _PatchBaseline.RuleGroup
ResourceDataSync.AwsOrganizationsSource = _ResourceDataSync.AwsOrganizationsSource
ResourceDataSync.S3Destination = _ResourceDataSync.S3Destination
ResourceDataSync.SyncSource = _ResourceDataSync.SyncSource
