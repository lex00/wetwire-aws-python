...
DataSource.CustomDocumentEnrichmentConfiguration = (
...
DataSource.InlineCustomDocumentEnrichmentConfiguration = (
    _DataSource.InlineCustomDocumentEnrichmentConfiguration
)
DataSource.TemplateConfiguration = _DataSource.TemplateConfiguration
Faq.S3Path = _Faq.S3Path
Index.CapacityUnitsConfiguration = _Index.CapacityUnitsConfiguration
Index.DocumentMetadataConfiguration = _Index.DocumentMetadataConfiguration
Index.JsonTokenTypeConfiguration = _Index.JsonTokenTypeConfiguration
Index.JwtTokenTypeConfiguration = _Index.JwtTokenTypeConfiguration
Index.Relevance = _Index.Relevance
Index.Search = _Index.Search
Index.ServerSideEncryptionConfiguration = _Index.ServerSideEncryptionConfiguration
Index.UserTokenConfiguration = _Index.UserTokenConfiguration
Index.ValueImportanceItem = _Index.ValueImportanceItem
