...
StreamProcessor.BoundingBox = PropertyTypeDescriptor(
    _StreamProcessor.BoundingBox, "BoundingBox"
)
StreamProcessor.ConnectedHomeSettings = PropertyTypeDescriptor(
    _StreamProcessor.ConnectedHomeSettings, "ConnectedHomeSettings"
)
StreamProcessor.DataSharingPreference = PropertyTypeDescriptor(
    _StreamProcessor.DataSharingPreference, "DataSharingPreference"
)
StreamProcessor.FaceSearchSettings = PropertyTypeDescriptor(
    _StreamProcessor.FaceSearchSettings, "FaceSearchSettings"
)
StreamProcessor.KinesisDataStream = PropertyTypeDescriptor(
    _StreamProcessor.KinesisDataStream, "KinesisDataStream"
)
StreamProcessor.KinesisVideoStream = PropertyTypeDescriptor(
    _StreamProcessor.KinesisVideoStream, "KinesisVideoStream"
)
StreamProcessor.NotificationChannel = PropertyTypeDescriptor(
    _StreamProcessor.NotificationChannel, "NotificationChannel"
)
StreamProcessor.S3Destination = PropertyTypeDescriptor(
    _StreamProcessor.S3Destination, "S3Destination"
)
