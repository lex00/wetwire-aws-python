...
class StreamProcessor(CloudFormationResource):
    ...
    kinesis_video_stream: DslValue[_StreamProcessor.KinesisVideoStream] | None = None
    role_arn: DslValue[str] | None = None
    bounding_box_regions_of_interest: list[DslValue[_StreamProcessor.BoundingBox]] = (
        field(default_factory=list)
    )
    connected_home_settings: DslValue[_StreamProcessor.ConnectedHomeSettings] | None = (
        None
    )
    data_sharing_preference: DslValue[_StreamProcessor.DataSharingPreference] | None = (
        None
    )
    face_search_settings: DslValue[_StreamProcessor.FaceSearchSettings] | None = None
    kinesis_data_stream: DslValue[_StreamProcessor.KinesisDataStream] | None = None
    kms_key_id: DslValue[str] | None = None
    name: DslValue[str] | None = None
    notification_channel: DslValue[_StreamProcessor.NotificationChannel] | None = None
    polygon_regions_of_interest: DslValue[dict[str, Any]] | None = None
    s3_destination: DslValue[_StreamProcessor.S3Destination] | None = None
    tags: list[DslValue[Tag]] = field(default_factory=list)
    ...
    BoundingBox = PropertyTypeDescriptor(_StreamProcessor.BoundingBox, "BoundingBox")
    ConnectedHomeSettings = PropertyTypeDescriptor(
        _StreamProcessor.ConnectedHomeSettings, "ConnectedHomeSettings"
    )
    DataSharingPreference = PropertyTypeDescriptor(
        _StreamProcessor.DataSharingPreference, "DataSharingPreference"
    )
    FaceSearchSettings = PropertyTypeDescriptor(
        _StreamProcessor.FaceSearchSettings, "FaceSearchSettings"
    )
    KinesisDataStream = PropertyTypeDescriptor(
        _StreamProcessor.KinesisDataStream, "KinesisDataStream"
    )
    KinesisVideoStream = PropertyTypeDescriptor(
        _StreamProcessor.KinesisVideoStream, "KinesisVideoStream"
    )
    NotificationChannel = PropertyTypeDescriptor(
