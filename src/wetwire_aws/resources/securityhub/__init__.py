...
AutomationRule.AutomationRulesAction = PropertyTypeDescriptor(
    _AutomationRule.AutomationRulesAction, "AutomationRulesAction"
)
AutomationRule.AutomationRulesFindingFieldsUpdate = PropertyTypeDescriptor(
    _AutomationRule.AutomationRulesFindingFieldsUpdate,
    "AutomationRulesFindingFieldsUpdate",
)
AutomationRule.AutomationRulesFindingFilters = PropertyTypeDescriptor(
    _AutomationRule.AutomationRulesFindingFilters, "AutomationRulesFindingFilters"
)
AutomationRule.DateFilter = PropertyTypeDescriptor(
    _AutomationRule.DateFilter, "DateFilter"
)
AutomationRule.DateRange = PropertyTypeDescriptor(
    _AutomationRule.DateRange, "DateRange"
)
AutomationRule.MapFilter = PropertyTypeDescriptor(
    _AutomationRule.MapFilter, "MapFilter"
)
AutomationRule.NoteUpdate = PropertyTypeDescriptor(
    _AutomationRule.NoteUpdate, "NoteUpdate"
)
AutomationRule.NumberFilter = PropertyTypeDescriptor(
    _AutomationRule.NumberFilter, "NumberFilter"
)
AutomationRule.RelatedFinding = PropertyTypeDescriptor(
    _AutomationRule.RelatedFinding, "RelatedFinding"
)
AutomationRule.SeverityUpdate = PropertyTypeDescriptor(
    _AutomationRule.SeverityUpdate, "SeverityUpdate"
)
AutomationRule.StringFilter = PropertyTypeDescriptor(
    _AutomationRule.StringFilter, "StringFilter"
)
AutomationRule.WorkflowUpdate = PropertyTypeDescriptor(
    _AutomationRule.WorkflowUpdate, "WorkflowUpdate"
)
AutomationRuleV2.AutomationRulesActionV2 = PropertyTypeDescriptor(
    _AutomationRuleV2.AutomationRulesActionV2, "AutomationRulesActionV2"
)
AutomationRuleV2.AutomationRulesFindingFieldsUpdateV2 = PropertyTypeDescriptor(
    _AutomationRuleV2.AutomationRulesFindingFieldsUpdateV2,
    "AutomationRulesFindingFieldsUpdateV2",
)
AutomationRuleV2.BooleanFilter = PropertyTypeDescriptor(
    _AutomationRuleV2.BooleanFilter, "BooleanFilter"
)
AutomationRuleV2.CompositeFilter = PropertyTypeDescriptor(
    _AutomationRuleV2.CompositeFilter, "CompositeFilter"
)
AutomationRuleV2.Criteria = PropertyTypeDescriptor(
    _AutomationRuleV2.Criteria, "Criteria"
)
AutomationRuleV2.DateFilter = PropertyTypeDescriptor(
    _AutomationRuleV2.DateFilter, "DateFilter"
)
AutomationRuleV2.DateRange = PropertyTypeDescriptor(
    _AutomationRuleV2.DateRange, "DateRange"
)
AutomationRuleV2.ExternalIntegrationConfiguration = PropertyTypeDescriptor(
    _AutomationRuleV2.ExternalIntegrationConfiguration,
    "ExternalIntegrationConfiguration",
)
AutomationRuleV2.MapFilter = PropertyTypeDescriptor(
    _AutomationRuleV2.MapFilter, "MapFilter"
)
AutomationRuleV2.NumberFilter = PropertyTypeDescriptor(
    _AutomationRuleV2.NumberFilter, "NumberFilter"
)
AutomationRuleV2.OcsfBooleanFilter = PropertyTypeDescriptor(
    _AutomationRuleV2.OcsfBooleanFilter, "OcsfBooleanFilter"
)
AutomationRuleV2.OcsfDateFilter = PropertyTypeDescriptor(
    _AutomationRuleV2.OcsfDateFilter, "OcsfDateFilter"
)
AutomationRuleV2.OcsfFindingFilters = PropertyTypeDescriptor(
    _AutomationRuleV2.OcsfFindingFilters, "OcsfFindingFilters"
)
AutomationRuleV2.OcsfMapFilter = PropertyTypeDescriptor(
    _AutomationRuleV2.OcsfMapFilter, "OcsfMapFilter"
)
AutomationRuleV2.OcsfNumberFilter = PropertyTypeDescriptor(
    _AutomationRuleV2.OcsfNumberFilter, "OcsfNumberFilter"
)
AutomationRuleV2.OcsfStringFilter = PropertyTypeDescriptor(
    _AutomationRuleV2.OcsfStringFilter, "OcsfStringFilter"
)
AutomationRuleV2.StringFilter = PropertyTypeDescriptor(
    _AutomationRuleV2.StringFilter, "StringFilter"
)
ConfigurationPolicy.ParameterConfiguration = PropertyTypeDescriptor(
    _ConfigurationPolicy.ParameterConfiguration, "ParameterConfiguration"
)
ConfigurationPolicy.ParameterValue = PropertyTypeDescriptor(
    _ConfigurationPolicy.ParameterValue, "ParameterValue"
)
ConfigurationPolicy.Policy = PropertyTypeDescriptor(
    _ConfigurationPolicy.Policy, "Policy"
)
ConfigurationPolicy.SecurityControlCustomParameter = PropertyTypeDescriptor(
    _ConfigurationPolicy.SecurityControlCustomParameter,
    "SecurityControlCustomParameter",
)
ConfigurationPolicy.SecurityControlsConfiguration = PropertyTypeDescriptor(
    _ConfigurationPolicy.SecurityControlsConfiguration, "SecurityControlsConfiguration"
)
ConfigurationPolicy.SecurityHubPolicy = PropertyTypeDescriptor(
    _ConfigurationPolicy.SecurityHubPolicy, "SecurityHubPolicy"
)
ConnectorV2.JiraCloudProviderConfiguration = PropertyTypeDescriptor(
    _ConnectorV2.JiraCloudProviderConfiguration, "JiraCloudProviderConfiguration"
)
ConnectorV2.Provider = PropertyTypeDescriptor(_ConnectorV2.Provider, "Provider")
ConnectorV2.ServiceNowProviderConfiguration = PropertyTypeDescriptor(
    _ConnectorV2.ServiceNowProviderConfiguration, "ServiceNowProviderConfiguration"
)
Insight.AwsSecurityFindingFilters = PropertyTypeDescriptor(
    _Insight.AwsSecurityFindingFilters, "AwsSecurityFindingFilters"
)
Insight.BooleanFilter = PropertyTypeDescriptor(_Insight.BooleanFilter, "BooleanFilter")
Insight.DateFilter = PropertyTypeDescriptor(_Insight.DateFilter, "DateFilter")
Insight.DateRange = PropertyTypeDescriptor(_Insight.DateRange, "DateRange")
Insight.IpFilter = PropertyTypeDescriptor(_Insight.IpFilter, "IpFilter")
Insight.MapFilter = PropertyTypeDescriptor(_Insight.MapFilter, "MapFilter")
Insight.NumberFilter = PropertyTypeDescriptor(_Insight.NumberFilter, "NumberFilter")
Insight.StringFilter = PropertyTypeDescriptor(_Insight.StringFilter, "StringFilter")
SecurityControl.ParameterConfiguration = PropertyTypeDescriptor(
    _SecurityControl.ParameterConfiguration, "ParameterConfiguration"
)
SecurityControl.ParameterValue = PropertyTypeDescriptor(
    _SecurityControl.ParameterValue, "ParameterValue"
)
Standard.StandardsControl = PropertyTypeDescriptor(
    _Standard.StandardsControl, "StandardsControl"
)
