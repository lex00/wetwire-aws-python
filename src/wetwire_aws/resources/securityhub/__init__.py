...
class AggregatorV2(CloudFormationResource):
    ...
    linked_regions: list[DslValue[str]] = field(default_factory=list)
    region_linking_mode: DslValue[str] | None = None
...
class AutomationRule(CloudFormationResource):
    ...
    actions: list[DslValue[_AutomationRule.AutomationRulesAction]] = field(
        default_factory=list
    )
    criteria: DslValue[_AutomationRule.AutomationRulesFindingFilters] | None = None
    description: DslValue[str] | None = None
    rule_name: DslValue[str] | None = None
    rule_order: DslValue[int] | None = None
    is_terminal: DslValue[bool] | None = None
    rule_status: DslValue[str] | None = None
    tags: dict[str, DslValue[str]] = field(default_factory=dict)
    ...
    AutomationRulesAction = PropertyTypeDescriptor(
        _AutomationRule.AutomationRulesAction, "AutomationRulesAction"
    )
    AutomationRulesFindingFieldsUpdate = PropertyTypeDescriptor(
        _AutomationRule.AutomationRulesFindingFieldsUpdate,
        "AutomationRulesFindingFieldsUpdate",
    )
    AutomationRulesFindingFilters = PropertyTypeDescriptor(
        _AutomationRule.AutomationRulesFindingFilters, "AutomationRulesFindingFilters"
    )
    DateFilter = PropertyTypeDescriptor(_AutomationRule.DateFilter, "DateFilter")
    DateRange = PropertyTypeDescriptor(_AutomationRule.DateRange, "DateRange")
    MapFilter = PropertyTypeDescriptor(_AutomationRule.MapFilter, "MapFilter")
    NoteUpdate = PropertyTypeDescriptor(_AutomationRule.NoteUpdate, "NoteUpdate")
    NumberFilter = PropertyTypeDescriptor(_AutomationRule.NumberFilter, "NumberFilter")
    RelatedFinding = PropertyTypeDescriptor(
        _AutomationRule.RelatedFinding, "RelatedFinding"
    )
    SeverityUpdate = PropertyTypeDescriptor(
        _AutomationRule.SeverityUpdate, "SeverityUpdate"
    )
    StringFilter = PropertyTypeDescriptor(_AutomationRule.StringFilter, "StringFilter")
    WorkflowUpdate = PropertyTypeDescriptor(
...
class AutomationRuleV2(CloudFormationResource):
    ...
    actions: list[DslValue[_AutomationRuleV2.AutomationRulesActionV2]] = field(
        default_factory=list
    )
    criteria: DslValue[_AutomationRuleV2.Criteria] | None = None
    description: DslValue[str] | None = None
    rule_name: DslValue[str] | None = None
    rule_order: DslValue[float] | None = None
    rule_status: DslValue[str] | None = None
    tags: dict[str, DslValue[str]] = field(default_factory=dict)
    ...
    # PropertyType descriptors for nested GetAtt support
    AutomationRulesActionV2 = PropertyTypeDescriptor(
        _AutomationRuleV2.AutomationRulesActionV2, "AutomationRulesActionV2"
    )
    AutomationRulesFindingFieldsUpdateV2 = PropertyTypeDescriptor(
        _AutomationRuleV2.AutomationRulesFindingFieldsUpdateV2,
        "AutomationRulesFindingFieldsUpdateV2",
    )
    BooleanFilter = PropertyTypeDescriptor(
        _AutomationRuleV2.BooleanFilter, "BooleanFilter"
    )
    CompositeFilter = PropertyTypeDescriptor(
        _AutomationRuleV2.CompositeFilter, "CompositeFilter"
    )
    Criteria = PropertyTypeDescriptor(_AutomationRuleV2.Criteria, "Criteria")
    DateFilter = PropertyTypeDescriptor(_AutomationRuleV2.DateFilter, "DateFilter")
    DateRange = PropertyTypeDescriptor(_AutomationRuleV2.DateRange, "DateRange")
    ExternalIntegrationConfiguration = PropertyTypeDescriptor(
        _AutomationRuleV2.ExternalIntegrationConfiguration,
        "ExternalIntegrationConfiguration",
    )
    MapFilter = PropertyTypeDescriptor(_AutomationRuleV2.MapFilter, "MapFilter")
    NumberFilter = PropertyTypeDescriptor(
        _AutomationRuleV2.NumberFilter, "NumberFilter"
    )
    OcsfBooleanFilter = PropertyTypeDescriptor(
        _AutomationRuleV2.OcsfBooleanFilter, "OcsfBooleanFilter"
    )
    OcsfDateFilter = PropertyTypeDescriptor(
        _AutomationRuleV2.OcsfDateFilter, "OcsfDateFilter"
    )
    OcsfFindingFilters = PropertyTypeDescriptor(
        _AutomationRuleV2.OcsfFindingFilters, "OcsfFindingFilters"
    )
    OcsfMapFilter = PropertyTypeDescriptor(
        _AutomationRuleV2.OcsfMapFilter, "OcsfMapFilter"
    )
    OcsfNumberFilter = PropertyTypeDescriptor(
        _AutomationRuleV2.OcsfNumberFilter, "OcsfNumberFilter"
    )
    OcsfStringFilter = PropertyTypeDescriptor(
        _AutomationRuleV2.OcsfStringFilter, "OcsfStringFilter"
    )
    StringFilter = PropertyTypeDescriptor(
...
class ConfigurationPolicy(CloudFormationResource):
    ...
    configuration_policy: DslValue[_ConfigurationPolicy.Policy] | None = None
    ...
    # PropertyType descriptors for nested GetAtt support
    ParameterConfiguration = PropertyTypeDescriptor(
        _ConfigurationPolicy.ParameterConfiguration, "ParameterConfiguration"
    )
    ParameterValue = PropertyTypeDescriptor(
        _ConfigurationPolicy.ParameterValue, "ParameterValue"
    )
    Policy = PropertyTypeDescriptor(_ConfigurationPolicy.Policy, "Policy")
    SecurityControlCustomParameter = PropertyTypeDescriptor(
        _ConfigurationPolicy.SecurityControlCustomParameter,
        "SecurityControlCustomParameter",
    )
    SecurityControlsConfiguration = PropertyTypeDescriptor(
        _ConfigurationPolicy.SecurityControlsConfiguration,
        "SecurityControlsConfiguration",
    )
    SecurityHubPolicy = PropertyTypeDescriptor(
...
class ConnectorV2(CloudFormationResource):
    ...
    name: DslValue[str] | None = None
    provider: DslValue[_ConnectorV2.Provider] | None = None
    description: DslValue[str] | None = None
    ...
    # PropertyType descriptors for nested GetAtt support
    JiraCloudProviderConfiguration = PropertyTypeDescriptor(
        _ConnectorV2.JiraCloudProviderConfiguration, "JiraCloudProviderConfiguration"
    )
    Provider = PropertyTypeDescriptor(_ConnectorV2.Provider, "Provider")
    ServiceNowProviderConfiguration = PropertyTypeDescriptor(
...
class DelegatedAdmin(CloudFormationResource):
    ...
    admin_account_id: DslValue[str] | None = None
...
class Hub(CloudFormationResource):
    ...
    auto_enable_controls: DslValue[bool] | None = None
    control_finding_generator: DslValue[str] | None = None
    enable_default_standards: DslValue[bool] | None = None
    tags: dict[str, DslValue[str]] = field(default_factory=dict)
...
class Insight(CloudFormationResource):
    ...
    filters: DslValue[_Insight.AwsSecurityFindingFilters] | None = None
    group_by_attribute: DslValue[str] | None = None
    name: DslValue[str] | None = None
    ...
    # PropertyType descriptors for nested GetAtt support
    AwsSecurityFindingFilters = PropertyTypeDescriptor(
        _Insight.AwsSecurityFindingFilters, "AwsSecurityFindingFilters"
    )
    BooleanFilter = PropertyTypeDescriptor(_Insight.BooleanFilter, "BooleanFilter")
    DateFilter = PropertyTypeDescriptor(_Insight.DateFilter, "DateFilter")
    DateRange = PropertyTypeDescriptor(_Insight.DateRange, "DateRange")
    IpFilter = PropertyTypeDescriptor(_Insight.IpFilter, "IpFilter")
    MapFilter = PropertyTypeDescriptor(_Insight.MapFilter, "MapFilter")
    NumberFilter = PropertyTypeDescriptor(_Insight.NumberFilter, "NumberFilter")
    StringFilter = PropertyTypeDescriptor(_Insight.StringFilter, "StringFilter")
...
class OrganizationConfiguration(CloudFormationResource):
    ...
    auto_enable: DslValue[bool] | None = None
    auto_enable_standards: DslValue[str] | None = None
...
class PolicyAssociation(CloudFormationResource):
    ...
    configuration_policy_id: DslValue[str] | None = None
...
class SecurityControl(CloudFormationResource):
    ...
    parameters: dict[str, DslValue[_SecurityControl.ParameterConfiguration]] = field(
        default_factory=dict
    )
    last_update_reason: DslValue[str] | None = None
    security_control_arn: DslValue[str] | None = None
...
class Standard(CloudFormationResource):
    ...
    standards_arn: DslValue[str] | None = None
    disabled_standards_controls: list[DslValue[_Standard.StandardsControl]] = field(
        default_factory=list
    )
    ...
    # PropertyType descriptors for nested GetAtt support
    StandardsControl = PropertyTypeDescriptor(
