...
class InvoiceUnit(CloudFormationResource):
    ...
    invoice_receiver: DslValue[str] | None = None
    name: DslValue[str] | None = None
    rule: DslValue[_InvoiceUnit.Rule] | None = None
    description: DslValue[str] | None = None
    resource_tags: list[DslValue[_InvoiceUnit.ResourceTag]] = field(
        default_factory=list
    )
    tax_inheritance_disabled: DslValue[bool] | None = None
    ...
    ResourceTag = PropertyTypeDescriptor(_InvoiceUnit.ResourceTag, "ResourceTag")
    Rule = PropertyTypeDescriptor(_InvoiceUnit.Rule, "Rule")
