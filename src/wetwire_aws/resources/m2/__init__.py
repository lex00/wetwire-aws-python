...
Application.Definition = _Application.Definition
Environment.EfsStorageConfiguration = _Environment.EfsStorageConfiguration
Environment.FsxStorageConfiguration = _Environment.FsxStorageConfiguration
Environment.HighAvailabilityConfig = _Environment.HighAvailabilityConfig
Environment.StorageConfiguration = _Environment.StorageConfiguration
