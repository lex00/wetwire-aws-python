...
class AnomalyMonitor(CloudFormationResource):
    ...
    monitor_type: DslValue[str] | None = None
    monitor_dimension: DslValue[str] | None = None
    monitor_specification: DslValue[str] | None = None
    resource_tags: list[DslValue[_AnomalyMonitor.ResourceTag]] = field(
    ...
    ResourceTag = PropertyTypeDescriptor(_AnomalyMonitor.ResourceTag, "ResourceTag")
...
class AnomalySubscription(CloudFormationResource):
    ...
    monitor_arn_list: list[DslValue[str]] = field(default_factory=list)
    subscribers: list[DslValue[_AnomalySubscription.Subscriber]] = field(
        default_factory=list
    )
    subscription_name: DslValue[str] | None = None
    resource_tags: list[DslValue[_AnomalySubscription.ResourceTag]] = field(
        default_factory=list
    )
    threshold: DslValue[float] | None = None
    threshold_expression: DslValue[str] | None = None
    ...
    # PropertyType descriptors for nested GetAtt support
    ResourceTag = PropertyTypeDescriptor(
        _AnomalySubscription.ResourceTag, "ResourceTag"
    )
    Subscriber = PropertyTypeDescriptor(_AnomalySubscription.Subscriber, "Subscriber")
...
class CostCategory(CloudFormationResource):
    ...
    split_charge_rules: DslValue[str] | None = None
    tags: list[DslValue[_CostCategory.ResourceTag]] = field(default_factory=list)
    ...
    # PropertyType descriptors for nested GetAtt support
    ResourceTag = PropertyTypeDescriptor(_CostCategory.ResourceTag, "ResourceTag")
