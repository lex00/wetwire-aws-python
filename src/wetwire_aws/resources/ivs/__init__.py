...
Channel.MultitrackInputConfiguration = _Channel.MultitrackInputConfiguration
EncoderConfiguration.Video = _EncoderConfiguration.Video
RecordingConfiguration.DestinationConfiguration = (
    _RecordingConfiguration.DestinationConfiguration
)
RecordingConfiguration.RenditionConfiguration = (
    _RecordingConfiguration.RenditionConfiguration
)
RecordingConfiguration.S3DestinationConfiguration = (
    _RecordingConfiguration.S3DestinationConfiguration
)
RecordingConfiguration.ThumbnailConfiguration = (
    _RecordingConfiguration.ThumbnailConfiguration
)
Stage.AutoParticipantRecordingConfiguration = (
    _Stage.AutoParticipantRecordingConfiguration
)
Stage.HlsConfiguration = _Stage.HlsConfiguration
Stage.ParticipantRecordingHlsConfiguration = _Stage.ParticipantRecordingHlsConfiguration
Stage.ParticipantThumbnailConfiguration = _Stage.ParticipantThumbnailConfiguration
Stage.ThumbnailConfiguration = _Stage.ThumbnailConfiguration
StorageConfiguration.S3StorageConfiguration = (
    _StorageConfiguration.S3StorageConfiguration
)
