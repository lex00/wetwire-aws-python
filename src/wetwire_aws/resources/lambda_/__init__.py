...
Alias.AliasRoutingConfiguration = PropertyTypeDescriptor(
    _Alias.AliasRoutingConfiguration, "AliasRoutingConfiguration"
)
Alias.ProvisionedConcurrencyConfiguration = PropertyTypeDescriptor(
    _Alias.ProvisionedConcurrencyConfiguration, "ProvisionedConcurrencyConfiguration"
)
Alias.VersionWeight = PropertyTypeDescriptor(_Alias.VersionWeight, "VersionWeight")
CapacityProvider.CapacityProviderPermissionsConfig = PropertyTypeDescriptor(
    _CapacityProvider.CapacityProviderPermissionsConfig,
    "CapacityProviderPermissionsConfig",
)
CapacityProvider.CapacityProviderScalingConfig = PropertyTypeDescriptor(
    _CapacityProvider.CapacityProviderScalingConfig, "CapacityProviderScalingConfig"
)
CapacityProvider.CapacityProviderVpcConfig = PropertyTypeDescriptor(
    _CapacityProvider.CapacityProviderVpcConfig, "CapacityProviderVpcConfig"
)
CapacityProvider.InstanceRequirements = PropertyTypeDescriptor(
    _CapacityProvider.InstanceRequirements, "InstanceRequirements"
)
CapacityProvider.TargetTrackingScalingPolicy = PropertyTypeDescriptor(
    _CapacityProvider.TargetTrackingScalingPolicy, "TargetTrackingScalingPolicy"
)
CodeSigningConfig.AllowedPublishers = PropertyTypeDescriptor(
    _CodeSigningConfig.AllowedPublishers, "AllowedPublishers"
)
CodeSigningConfig.CodeSigningPolicies = PropertyTypeDescriptor(
    _CodeSigningConfig.CodeSigningPolicies, "CodeSigningPolicies"
)
EventInvokeConfig.DestinationConfig = PropertyTypeDescriptor(
    _EventInvokeConfig.DestinationConfig, "DestinationConfig"
)
EventInvokeConfig.OnFailure = PropertyTypeDescriptor(
    _EventInvokeConfig.OnFailure, "OnFailure"
)
EventInvokeConfig.OnSuccess = PropertyTypeDescriptor(
    _EventInvokeConfig.OnSuccess, "OnSuccess"
)
EventSourceMapping.AmazonManagedKafkaEventSourceConfig = PropertyTypeDescriptor(
    _EventSourceMapping.AmazonManagedKafkaEventSourceConfig,
    "AmazonManagedKafkaEventSourceConfig",
)
EventSourceMapping.DestinationConfig = PropertyTypeDescriptor(
    _EventSourceMapping.DestinationConfig, "DestinationConfig"
)
EventSourceMapping.DocumentDBEventSourceConfig = PropertyTypeDescriptor(
    _EventSourceMapping.DocumentDBEventSourceConfig, "DocumentDBEventSourceConfig"
)
EventSourceMapping.Endpoints = PropertyTypeDescriptor(
    _EventSourceMapping.Endpoints, "Endpoints"
)
EventSourceMapping.Filter = PropertyTypeDescriptor(_EventSourceMapping.Filter, "Filter")
EventSourceMapping.FilterCriteria = PropertyTypeDescriptor(
    _EventSourceMapping.FilterCriteria, "FilterCriteria"
)
EventSourceMapping.LoggingConfig = PropertyTypeDescriptor(
    _EventSourceMapping.LoggingConfig, "LoggingConfig"
)
EventSourceMapping.MetricsConfig = PropertyTypeDescriptor(
    _EventSourceMapping.MetricsConfig, "MetricsConfig"
)
EventSourceMapping.OnFailure = PropertyTypeDescriptor(
    _EventSourceMapping.OnFailure, "OnFailure"
)
EventSourceMapping.ProvisionedPollerConfig = PropertyTypeDescriptor(
    _EventSourceMapping.ProvisionedPollerConfig, "ProvisionedPollerConfig"
)
EventSourceMapping.ScalingConfig = PropertyTypeDescriptor(
    _EventSourceMapping.ScalingConfig, "ScalingConfig"
)
EventSourceMapping.SchemaRegistryAccessConfig = PropertyTypeDescriptor(
    _EventSourceMapping.SchemaRegistryAccessConfig, "SchemaRegistryAccessConfig"
)
EventSourceMapping.SchemaRegistryConfig = PropertyTypeDescriptor(
    _EventSourceMapping.SchemaRegistryConfig, "SchemaRegistryConfig"
)
EventSourceMapping.SchemaValidationConfig = PropertyTypeDescriptor(
    _EventSourceMapping.SchemaValidationConfig, "SchemaValidationConfig"
)
EventSourceMapping.SelfManagedEventSource = PropertyTypeDescriptor(
    _EventSourceMapping.SelfManagedEventSource, "SelfManagedEventSource"
)
EventSourceMapping.SelfManagedKafkaEventSourceConfig = PropertyTypeDescriptor(
    _EventSourceMapping.SelfManagedKafkaEventSourceConfig,
    "SelfManagedKafkaEventSourceConfig",
)
EventSourceMapping.SourceAccessConfiguration = PropertyTypeDescriptor(
    _EventSourceMapping.SourceAccessConfiguration, "SourceAccessConfiguration"
)
Function.CapacityProviderConfig = PropertyTypeDescriptor(
    _Function.CapacityProviderConfig, "CapacityProviderConfig"
)
Function.Code = PropertyTypeDescriptor(_Function.Code, "Code")
Function.DeadLetterConfig = PropertyTypeDescriptor(
    _Function.DeadLetterConfig, "DeadLetterConfig"
)
Function.DurableConfig = PropertyTypeDescriptor(
    _Function.DurableConfig, "DurableConfig"
)
...
Function.FileSystemConfig = PropertyTypeDescriptor(
    _Function.FileSystemConfig, "FileSystemConfig"
)
Function.FunctionScalingConfig = PropertyTypeDescriptor(
    _Function.FunctionScalingConfig, "FunctionScalingConfig"
)
Function.ImageConfig = PropertyTypeDescriptor(_Function.ImageConfig, "ImageConfig")
Function.LambdaManagedInstancesCapacityProviderConfig = PropertyTypeDescriptor(
...
Function.RuntimeManagementConfig = PropertyTypeDescriptor(
...
Function.SnapStartResponse = PropertyTypeDescriptor(
    _Function.SnapStartResponse, "SnapStartResponse"
)
Function.TenancyConfig = PropertyTypeDescriptor(
    _Function.TenancyConfig, "TenancyConfig"
)
Function.TracingConfig = PropertyTypeDescriptor(
    _Function.TracingConfig, "TracingConfig"
)
Function.VpcConfig = PropertyTypeDescriptor(_Function.VpcConfig, "VpcConfig")
LayerVersion.Content = PropertyTypeDescriptor(_LayerVersion.Content, "Content")
Url.Cors = PropertyTypeDescriptor(_Url.Cors, "Cors")
Version.FunctionScalingConfig = PropertyTypeDescriptor(
    _Version.FunctionScalingConfig, "FunctionScalingConfig"
)
Version.ProvisionedConcurrencyConfiguration = PropertyTypeDescriptor(
    _Version.ProvisionedConcurrencyConfiguration, "ProvisionedConcurrencyConfiguration"
)
Version.RuntimePolicy = PropertyTypeDescriptor(_Version.RuntimePolicy, "RuntimePolicy")
