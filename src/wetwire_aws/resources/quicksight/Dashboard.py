...
class AssetOptions(PropertyType):
    excluded_data_set_arns: list[String] = field(default_factory=list)
    q_business_insights_status: str | None = None
...
class DashboardPublishOptions(PropertyType):
    ...
    ad_hoc_filtering_option: AdHocFilteringOption | None = None
    data_point_drill_up_down_option: DataPointDrillUpDownOption | None = None
    data_point_menu_label_option: DataPointMenuLabelOption | None = None
    data_point_tooltip_option: DataPointTooltipOption | None = None
    data_qa_enabled_option: DataQAEnabledOption | None = None
    data_stories_sharing_option: DataStoriesSharingOption | None = None
    executive_summary_option: ExecutiveSummaryOption | None = None
    export_to_csv_option: ExportToCSVOption | None = None
    export_with_hidden_fields_option: ExportWithHiddenFieldsOption | None = None
    quick_suite_actions_option: QuickSuiteActionsOption | None = None
    sheet_controls_option: SheetControlsOption | None = None
    sheet_layout_element_maximization_option: (
        SheetLayoutElementMaximizationOption | None
    ) = None
    visual_axis_sort_option: VisualAxisSortOption | None = None
    visual_menu_option: VisualMenuOption | None = None
    visual_publish_options: DashboardVisualPublishOptions | None = None


@dataclass
class DashboardSourceEntity(PropertyType):
    source_template: DashboardSourceTemplate | None = None
...
class DashboardVersion(PropertyType):
    ...
    data_set_arns: list[String] = field(default_factory=list)
...
class DashboardVisualPublishOptions(PropertyType):
    export_hidden_fields_option: ExportHiddenFieldsOption | None = None
...
class GridLayoutElement(PropertyType):
    ...
    background_style: GridLayoutElementBackgroundStyle | None = None
    border_radius: str | None = None
    border_style: GridLayoutElementBorderStyle | None = None
    column_index: float | None = None
    loading_animation: LoadingAnimation | None = None
    padding: str | None = None
    row_index: float | None = None
    selected_border_style: GridLayoutElementBorderStyle | None = None
