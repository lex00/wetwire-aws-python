...
class AssetOptions(PropertyType):
    excluded_data_set_arns: list[DslValue[str]] = field(default_factory=list)
    q_business_insights_status: DslValue[str] | None = None
...
class AxisDisplayOptions(PropertyType):
    axis_line_visibility: DslValue[str] | None = None
    axis_offset: DslValue[str] | None = None
    data_options: DslValue[AxisDataOptions] | None = None
    grid_line_visibility: DslValue[str] | None = None
...
class BoxPlotOptions(PropertyType):
    all_data_points_visibility: DslValue[str] | None = None
    outlier_visibility: DslValue[str] | None = None
...
class ChartAxisLabelOptions(PropertyType):
    ...
    sort_icon_visibility: DslValue[str] | None = None
...
class DashboardPublishOptions(PropertyType):
    ...
    ad_hoc_filtering_option: DslValue[AdHocFilteringOption] | None = None
    data_point_drill_up_down_option: DslValue[DataPointDrillUpDownOption] | None = None
    data_point_menu_label_option: DslValue[DataPointMenuLabelOption] | None = None
    data_point_tooltip_option: DslValue[DataPointTooltipOption] | None = None
    data_qa_enabled_option: DslValue[DataQAEnabledOption] | None = None
    data_stories_sharing_option: DslValue[DataStoriesSharingOption] | None = None
    executive_summary_option: DslValue[ExecutiveSummaryOption] | None = None
    export_to_csv_option: DslValue[ExportToCSVOption] | None = None
    export_with_hidden_fields_option: DslValue[ExportWithHiddenFieldsOption] | None = (
        None
    )
    quick_suite_actions_option: DslValue[QuickSuiteActionsOption] | None = None
    sheet_controls_option: DslValue[SheetControlsOption] | None = None
    sheet_layout_element_maximization_option: (
        DslValue[SheetLayoutElementMaximizationOption] | None
    ) = None
    visual_axis_sort_option: DslValue[VisualAxisSortOption] | None = None
    visual_menu_option: DslValue[VisualMenuOption] | None = None
    visual_publish_options: DslValue[DashboardVisualPublishOptions] | None = None


@dataclass
class DashboardSourceEntity(PropertyType):
    source_template: DslValue[DashboardSourceTemplate] | None = None
...
class DashboardVersion(PropertyType):
    ...
    data_set_arns: list[DslValue[str]] = field(default_factory=list)
    description: DslValue[str] | None = None
    errors: list[DslValue[DashboardError]] = field(default_factory=list)
...
class DashboardVersionDefinition(PropertyType):
    data_set_identifier_declarations: list[DslValue[DataSetIdentifierDeclaration]] = (
        field(default_factory=list)
    )
    ...
    static_files: list[DslValue[StaticFile]] = field(default_factory=list)


@dataclass
class DashboardVisualPublishOptions(PropertyType):
    export_hidden_fields_option: DslValue[ExportHiddenFieldsOption] | None = None
...
class DataLabelOptions(PropertyType):
    category_label_visibility: DslValue[str] | None = None
    ...
    measure_label_visibility: DslValue[str] | None = None
    overlap: DslValue[str] | None = None
    position: DslValue[str] | None = None
    totals_visibility: DslValue[str] | None = None
    visibility: DslValue[str] | None = None
...
class DateAxisOptions(PropertyType):
    missing_date_visibility: DslValue[str] | None = None
...
class DateTimePickerControlDisplayOptions(PropertyType):
    date_icon_visibility: DslValue[str] | None = None
    date_time_format: DslValue[str] | None = None
    helper_text_visibility: DslValue[str] | None = None
...
class DecimalParameter(PropertyType):
    name: DslValue[str] | None = None
    values: list[DslValue[float]] = field(default_factory=list)
...
class DonutCenterOptions(PropertyType):
    label_visibility: DslValue[str] | None = None
...
class FieldBasedTooltip(PropertyType):
    aggregation_visibility: DslValue[str] | None = None
...
class GeospatialCategoricalColor(PropertyType):
    category_data_colors: list[DslValue[GeospatialCategoricalDataColor]] = field(
        default_factory=list
    )
    default_opacity: DslValue[float] | None = None
    null_data_settings: DslValue[GeospatialNullDataSettings] | None = None
    null_data_visibility: DslValue[str] | None = None


@dataclass
class GeospatialCategoricalDataColor(PropertyType):
    color: DslValue[str] | None = None
    data_value: DslValue[str] | None = None


@dataclass
class GeospatialCircleRadius(PropertyType):
    radius: DslValue[float] | None = None


@dataclass
class GeospatialCircleSymbolStyle(PropertyType):
    circle_radius: DslValue[GeospatialCircleRadius] | None = None
    fill_color: DslValue[GeospatialColor] | None = None
    stroke_color: DslValue[GeospatialColor] | None = None
    stroke_width: DslValue[GeospatialLineWidth] | None = None


@dataclass
class GeospatialColor(PropertyType):
    categorical: DslValue[GeospatialCategoricalColor] | None = None
    gradient: DslValue[GeospatialGradientColor] | None = None
    solid: DslValue[GeospatialSolidColor] | None = None
...
class GeospatialDataSourceItem(PropertyType):
    static_file_data_source: DslValue[GeospatialStaticFileSource] | None = None


@dataclass
class GeospatialGradientColor(PropertyType):
    step_colors: list[DslValue[GeospatialGradientStepColor]] = field(
        default_factory=list
    )
    default_opacity: DslValue[float] | None = None
    null_data_settings: DslValue[GeospatialNullDataSettings] | None = None
...
class GeospatialLayerColorField(PropertyType):
    color_dimensions_fields: list[DslValue[DimensionField]] = field(
        default_factory=list
    )
    color_values_fields: list[DslValue[MeasureField]] = field(default_factory=list)


@dataclass
class GeospatialLayerDefinition(PropertyType):
    line_layer: DslValue[GeospatialLineLayer] | None = None
    point_layer: DslValue[GeospatialPointLayer] | None = None
    polygon_layer: DslValue[GeospatialPolygonLayer] | None = None


@dataclass
class GeospatialLayerItem(PropertyType):
    layer_id: DslValue[str] | None = None
    actions: list[DslValue[LayerCustomAction]] = field(default_factory=list)
    data_source: DslValue[GeospatialDataSourceItem] | None = None
    join_definition: DslValue[GeospatialLayerJoinDefinition] | None = None
    label: DslValue[str] | None = None
    layer_definition: DslValue[GeospatialLayerDefinition] | None = None
    layer_type: DslValue[str] | None = None
    tooltip: DslValue[TooltipOptions] | None = None
    visibility: DslValue[str] | None = None
...
class GeospatialLayerJoinDefinition(PropertyType):
    color_field: DslValue[GeospatialLayerColorField] | None = None
    dataset_key_field: DslValue[UnaggregatedField] | None = None
    shape_key_field: DslValue[str] | None = None
...
class GeospatialLayerMapConfiguration(PropertyType):
    interactions: DslValue[VisualInteractionOptions] | None = None
    legend: DslValue[LegendOptions] | None = None
    map_layers: list[DslValue[GeospatialLayerItem]] = field(default_factory=list)
    map_state: DslValue[GeospatialMapState] | None = None
    map_style: DslValue[GeospatialMapStyle] | None = None


@dataclass
class GeospatialLineLayer(PropertyType):
    style: DslValue[GeospatialLineStyle] | None = None


@dataclass
class GeospatialLineStyle(PropertyType):
    line_symbol_style: DslValue[GeospatialLineSymbolStyle] | None = None


@dataclass
class GeospatialLineSymbolStyle(PropertyType):
    fill_color: DslValue[GeospatialColor] | None = None
    line_width: DslValue[GeospatialLineWidth] | None = None


@dataclass
class GeospatialLineWidth(PropertyType):
    line_width: DslValue[float] | None = None
...
class GeospatialMapState(PropertyType):
    ...
    map_navigation: DslValue[str] | None = None
...
class GeospatialMapStyle(PropertyType):
    ...
    base_map_visibility: DslValue[str] | None = None
...
class GeospatialNullDataSettings(PropertyType):
    symbol_style: DslValue[GeospatialNullSymbolStyle] | None = None


@dataclass
class GeospatialNullSymbolStyle(PropertyType):
    fill_color: DslValue[str] | None = None
    stroke_color: DslValue[str] | None = None
    stroke_width: DslValue[float] | None = None


@dataclass
class GeospatialPointLayer(PropertyType):
    style: DslValue[GeospatialPointStyle] | None = None


@dataclass
class GeospatialPointStyle(PropertyType):
    circle_symbol_style: DslValue[GeospatialCircleSymbolStyle] | None = None
...
class GeospatialPolygonLayer(PropertyType):
    style: DslValue[GeospatialPolygonStyle] | None = None


@dataclass
class GeospatialPolygonStyle(PropertyType):
    polygon_symbol_style: DslValue[GeospatialPolygonSymbolStyle] | None = None
...
class GridLayoutElement(PropertyType):
    ...
    background_style: DslValue[GridLayoutElementBackgroundStyle] | None = None
    border_radius: DslValue[str] | None = None
    border_style: DslValue[GridLayoutElementBorderStyle] | None = None
    column_index: DslValue[float] | None = None
    loading_animation: DslValue[LoadingAnimation] | None = None
    padding: DslValue[str] | None = None
    row_index: DslValue[float] | None = None
    selected_border_style: DslValue[GridLayoutElementBorderStyle] | None = None


@dataclass
class GridLayoutElementBackgroundStyle(PropertyType):
    color: DslValue[str] | None = None
    visibility: DslValue[str] | None = None


@dataclass
class GridLayoutElementBorderStyle(PropertyType):
    color: DslValue[str] | None = None
    visibility: DslValue[str] | None = None
    width: DslValue[str] | None = None
...
class ImageStaticFile(PropertyType):
    static_file_id: DslValue[str] | None = None
    source: DslValue[StaticFileSource] | None = None
...
class KPISparklineOptions(PropertyType):
    type_: DslValue[str] | None = None
    color: DslValue[str] | None = None
    tooltip_visibility: DslValue[str] | None = None
    visibility: DslValue[str] | None = None
...
class LayerCustomAction(PropertyType):
    action_operations: list[DslValue[LayerCustomActionOperation]] = field(
        default_factory=list
    )
    custom_action_id: DslValue[str] | None = None
    name: DslValue[str] | None = None
...
class LayerMapVisual(PropertyType):
    data_set_identifier: DslValue[str] | None = None
    visual_id: DslValue[str] | None = None
    chart_configuration: DslValue[GeospatialLayerMapConfiguration] | None = None
    subtitle: DslValue[VisualSubtitleLabelOptions] | None = None
    title: DslValue[VisualTitleLabelOptions] | None = None
    visual_content_alt_text: DslValue[str] | None = None
...
class LineChartLineStyleSettings(PropertyType):
    ...
    line_visibility: DslValue[str] | None = None
...
class LineChartMarkerStyleSettings(PropertyType):
    ...
    marker_visibility: DslValue[str] | None = None
...
class LinkSharingConfiguration(PropertyType):
    permissions: list[DslValue[ResourcePermission]] = field(default_factory=list)
...
class Parameters(PropertyType):
    date_time_parameters: list[DslValue[DateTimeParameter]] = field(
        default_factory=list
    )
    decimal_parameters: list[DslValue[DecimalParameter]] = field(default_factory=list)
    integer_parameters: list[DslValue[IntegerParameter]] = field(default_factory=list)
    string_parameters: list[DslValue[StringParameter]] = field(default_factory=list)
...
class PivotTableOptions(PropertyType):
    ...
    collapsed_row_dimensions_visibility: DslValue[str] | None = None
    column_header_style: DslValue[TableCellStyle] | None = None
    column_names_visibility: DslValue[str] | None = None
    ...
    single_metric_visibility: DslValue[str] | None = None
    toggle_buttons_visibility: DslValue[str] | None = None


@dataclass
class PivotTablePaginatedReportOptions(PropertyType):
    overflow_column_header_visibility: DslValue[str] | None = None
    vertical_overflow_visibility: DslValue[str] | None = None
...
class RadarChartConfiguration(PropertyType):
    alternate_band_colors_visibility: DslValue[str] | None = None
...
class SheetControlsOption(PropertyType):
    visibility_state: DslValue[str] | None = None
...
class StaticFile(PropertyType):
    image_static_file: DslValue[ImageStaticFile] | None = None
    spatial_static_file: DslValue[SpatialStaticFile] | None = None
...
class StaticFileSource(PropertyType):
    s3_options: DslValue[StaticFileS3SourceOptions] | None = None
    url_options: DslValue[StaticFileUrlSourceOptions] | None = None
...
class Visual(PropertyType):
    ...
    layer_map_visual: DslValue[LayerMapVisual] | None = None
