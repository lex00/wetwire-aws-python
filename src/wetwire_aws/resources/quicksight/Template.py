...
class AxisDisplayOptions(PropertyType):
    axis_line_visibility: dict[str, Any] | None = None
    axis_offset: str | None = None
    data_options: AxisDataOptions | None = None
    grid_line_visibility: dict[str, Any] | None = None
...
class BoxPlotOptions(PropertyType):
    all_data_points_visibility: dict[str, Any] | None = None
    outlier_visibility: dict[str, Any] | None = None
...
class ChartAxisLabelOptions(PropertyType):
    ...
    sort_icon_visibility: dict[str, Any] | None = None
...
class ColumnGroupSchema(PropertyType):
    column_group_column_schema_list: list[ColumnGroupColumnSchema] = field(
        default_factory=list
    )
    name: str | None = None
...
class DataLabelOptions(PropertyType):
    category_label_visibility: dict[str, Any] | None = None
    ...
    measure_label_visibility: dict[str, Any] | None = None
    overlap: str | None = None
    position: str | None = None
    totals_visibility: dict[str, Any] | None = None
    visibility: dict[str, Any] | None = None
...
class DataSetConfiguration(PropertyType):
    column_group_schema_list: list[ColumnGroupSchema] = field(default_factory=list)
    data_set_schema: DataSetSchema | None = None
...
class DataSetSchema(PropertyType):
    column_schema_list: list[ColumnSchema] = field(default_factory=list)


@dataclass
class DateAxisOptions(PropertyType):
    missing_date_visibility: dict[str, Any] | None = None
...
class DateTimePickerControlDisplayOptions(PropertyType):
    date_icon_visibility: dict[str, Any] | None = None
    date_time_format: str | None = None
    helper_text_visibility: dict[str, Any] | None = None
...
class DonutCenterOptions(PropertyType):
    label_visibility: dict[str, Any] | None = None
...
class FieldBasedTooltip(PropertyType):
    aggregation_visibility: dict[str, Any] | None = None
...
class KPISparklineOptions(PropertyType):
    type_: str | None = None
    color: str | None = None
    tooltip_visibility: dict[str, Any] | None = None
    visibility: dict[str, Any] | None = None
...
class LineChartLineStyleSettings(PropertyType):
    ...
    line_visibility: dict[str, Any] | None = None
...
class LineChartMarkerStyleSettings(PropertyType):
    ...
    marker_visibility: dict[str, Any] | None = None
...
class PanelConfiguration(PropertyType):
    background_color: str | None = None
    background_visibility: dict[str, Any] | None = None
    border_color: str | None = None
    border_style: str | None = None
    border_thickness: str | None = None
    border_visibility: dict[str, Any] | None = None
    gutter_spacing: str | None = None
    gutter_visibility: dict[str, Any] | None = None
...
class PivotTableOptions(PropertyType):
    ...
    collapsed_row_dimensions_visibility: dict[str, Any] | None = None
    column_header_style: TableCellStyle | None = None
    column_names_visibility: dict[str, Any] | None = None
    ...
    single_metric_visibility: dict[str, Any] | None = None
    toggle_buttons_visibility: dict[str, Any] | None = None


@dataclass
class PivotTablePaginatedReportOptions(PropertyType):
    overflow_column_header_visibility: dict[str, Any] | None = None
    vertical_overflow_visibility: dict[str, Any] | None = None
...
class RadarChartConfiguration(PropertyType):
    alternate_band_colors_visibility: dict[str, Any] | None = None
...
class TemplateSourceEntity(PropertyType):
    source_analysis: TemplateSourceAnalysis | None = None
    source_template: TemplateSourceTemplate | None = None
...
class TemplateVersion(PropertyType):
    ...
    data_set_configurations: list[DataSetConfiguration] = field(default_factory=list)
    description: str | None = None
    errors: list[TemplateError] = field(default_factory=list)
    sheets: list[Sheet] = field(default_factory=list)
    source_entity_arn: str | None = None
    status: str | None = None
