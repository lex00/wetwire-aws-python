...
Channel.Destination = _Channel.Destination
Dashboard.Frequency = _Dashboard.Frequency
Dashboard.RefreshSchedule = _Dashboard.RefreshSchedule
Dashboard.Widget = _Dashboard.Widget
EventDataStore.AdvancedEventSelector = _EventDataStore.AdvancedEventSelector
EventDataStore.AdvancedFieldSelector = _EventDataStore.AdvancedFieldSelector
EventDataStore.ContextKeySelector = _EventDataStore.ContextKeySelector
EventDataStore.InsightSelector = _EventDataStore.InsightSelector
Trail.AdvancedEventSelector = _Trail.AdvancedEventSelector
Trail.AdvancedFieldSelector = _Trail.AdvancedFieldSelector
Trail.AggregationConfiguration = _Trail.AggregationConfiguration
Trail.DataResource = _Trail.DataResource
Trail.EventSelector = _Trail.EventSelector
Trail.InsightSelector = _Trail.InsightSelector
