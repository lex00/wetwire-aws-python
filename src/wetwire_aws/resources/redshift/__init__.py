...
Cluster.Endpoint = PropertyTypeDescriptor(_Cluster.Endpoint, "Endpoint")
Cluster.LoggingProperties = PropertyTypeDescriptor(
    _Cluster.LoggingProperties, "LoggingProperties"
)
ClusterParameterGroup.Parameter = PropertyTypeDescriptor(
    _ClusterParameterGroup.Parameter, "Parameter"
)
EndpointAccess.NetworkInterface = PropertyTypeDescriptor(
    _EndpointAccess.NetworkInterface, "NetworkInterface"
)
EndpointAccess.VpcEndpoint = PropertyTypeDescriptor(
    _EndpointAccess.VpcEndpoint, "VpcEndpoint"
)
EndpointAccess.VpcSecurityGroup = PropertyTypeDescriptor(
    _EndpointAccess.VpcSecurityGroup, "VpcSecurityGroup"
)
ScheduledAction.PauseClusterMessage = PropertyTypeDescriptor(
    _ScheduledAction.PauseClusterMessage, "PauseClusterMessage"
)
ScheduledAction.ResizeClusterMessage = PropertyTypeDescriptor(
    _ScheduledAction.ResizeClusterMessage, "ResizeClusterMessage"
)
ScheduledAction.ResumeClusterMessage = PropertyTypeDescriptor(
    _ScheduledAction.ResumeClusterMessage, "ResumeClusterMessage"
)
ScheduledAction.ScheduledActionType = PropertyTypeDescriptor(
