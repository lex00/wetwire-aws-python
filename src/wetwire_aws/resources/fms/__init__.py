...
class Policy(CloudFormationResource):
    ...
    exclude_resource_tags: bool | None = None
    policy_name: str | None = None
    remediation_enabled: bool | None = None
    security_service_policy_data: _Policy.SecurityServicePolicyData | None = None
    delete_all_policy_resources: bool | None = None
    exclude_map: _Policy.IEMap | None = None
    include_map: _Policy.IEMap | None = None
    policy_description: str | None = None
    resource_set_ids: list[String] = field(default_factory=list)
    resource_tag_logical_operator: str | None = None
    resource_tags: list[_Policy.ResourceTag] = field(default_factory=list)
    resource_type: str | None = None
    resource_type_list: list[String] = field(default_factory=list)
    resources_clean_up: bool | None = None
    tags: list[_Policy.PolicyTag] = field(default_factory=list)
...
Policy.IEMap = PropertyTypeDescriptor(_Policy.IEMap, "IEMap")
Policy.IcmpTypeCode = PropertyTypeDescriptor(_Policy.IcmpTypeCode, "IcmpTypeCode")
Policy.NetworkAclCommonPolicy = PropertyTypeDescriptor(
    _Policy.NetworkAclCommonPolicy, "NetworkAclCommonPolicy"
)
Policy.NetworkAclEntry = PropertyTypeDescriptor(
    _Policy.NetworkAclEntry, "NetworkAclEntry"
)
Policy.NetworkAclEntrySet = PropertyTypeDescriptor(
    _Policy.NetworkAclEntrySet, "NetworkAclEntrySet"
)
Policy.NetworkFirewallPolicy = PropertyTypeDescriptor(
    _Policy.NetworkFirewallPolicy, "NetworkFirewallPolicy"
)
Policy.PolicyOption = PropertyTypeDescriptor(_Policy.PolicyOption, "PolicyOption")
Policy.PolicyTag = PropertyTypeDescriptor(_Policy.PolicyTag, "PolicyTag")
Policy.PortRange = PropertyTypeDescriptor(_Policy.PortRange, "PortRange")
Policy.ResourceTag = PropertyTypeDescriptor(_Policy.ResourceTag, "ResourceTag")
Policy.SecurityServicePolicyData = PropertyTypeDescriptor(
    _Policy.SecurityServicePolicyData, "SecurityServicePolicyData"
)
Policy.ThirdPartyFirewallPolicy = PropertyTypeDescriptor(
