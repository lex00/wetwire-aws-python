...
class JobTemplate(CloudFormationResource):
    ...
    settings_json: DslValue[dict[str, Any]] | None = None
    acceleration_settings: DslValue[_JobTemplate.AccelerationSettings] | None = None
    category: DslValue[str] | None = None
    description: DslValue[str] | None = None
    hop_destinations: list[DslValue[_JobTemplate.HopDestination]] = field(
        default_factory=list
    )
    name: DslValue[str] | None = None
    priority: DslValue[int] | None = None
    queue: DslValue[str] | None = None
    status_update_interval: DslValue[str] | None = None
    ...
    AccelerationSettings = PropertyTypeDescriptor(
        _JobTemplate.AccelerationSettings, "AccelerationSettings"
    )
    HopDestination = PropertyTypeDescriptor(
...
class Queue(CloudFormationResource):
    ...
    concurrent_jobs: DslValue[int] | None = None
    description: DslValue[str] | None = None
    name: DslValue[str] | None = None
