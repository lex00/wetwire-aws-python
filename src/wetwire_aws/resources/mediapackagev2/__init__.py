...
Channel.InputSwitchConfiguration = PropertyTypeDescriptor(
    _Channel.InputSwitchConfiguration, "InputSwitchConfiguration"
)
Channel.OutputHeaderConfiguration = PropertyTypeDescriptor(
    _Channel.OutputHeaderConfiguration, "OutputHeaderConfiguration"
)
OriginEndpoint.DashBaseUrl = PropertyTypeDescriptor(
    _OriginEndpoint.DashBaseUrl, "DashBaseUrl"
)
OriginEndpoint.DashDvbFontDownload = PropertyTypeDescriptor(
    _OriginEndpoint.DashDvbFontDownload, "DashDvbFontDownload"
)
OriginEndpoint.DashDvbMetricsReporting = PropertyTypeDescriptor(
    _OriginEndpoint.DashDvbMetricsReporting, "DashDvbMetricsReporting"
)
OriginEndpoint.DashDvbSettings = PropertyTypeDescriptor(
    _OriginEndpoint.DashDvbSettings, "DashDvbSettings"
)
OriginEndpoint.DashManifestConfiguration = PropertyTypeDescriptor(
    _OriginEndpoint.DashManifestConfiguration, "DashManifestConfiguration"
)
OriginEndpoint.DashProgramInformation = PropertyTypeDescriptor(
    _OriginEndpoint.DashProgramInformation, "DashProgramInformation"
)
OriginEndpoint.DashSubtitleConfiguration = PropertyTypeDescriptor(
    _OriginEndpoint.DashSubtitleConfiguration, "DashSubtitleConfiguration"
)
OriginEndpoint.DashTtmlConfiguration = PropertyTypeDescriptor(
    _OriginEndpoint.DashTtmlConfiguration, "DashTtmlConfiguration"
)
OriginEndpoint.DashUtcTiming = PropertyTypeDescriptor(
    _OriginEndpoint.DashUtcTiming, "DashUtcTiming"
)
OriginEndpoint.Encryption = PropertyTypeDescriptor(
    _OriginEndpoint.Encryption, "Encryption"
)
...
OriginEndpoint.EncryptionMethod = PropertyTypeDescriptor(
    _OriginEndpoint.EncryptionMethod, "EncryptionMethod"
)
OriginEndpoint.FilterConfiguration = PropertyTypeDescriptor(
    _OriginEndpoint.FilterConfiguration, "FilterConfiguration"
)
OriginEndpoint.ForceEndpointErrorConfiguration = PropertyTypeDescriptor(
    _OriginEndpoint.ForceEndpointErrorConfiguration, "ForceEndpointErrorConfiguration"
)
OriginEndpoint.HlsManifestConfiguration = PropertyTypeDescriptor(
    _OriginEndpoint.HlsManifestConfiguration, "HlsManifestConfiguration"
)
OriginEndpoint.LowLatencyHlsManifestConfiguration = PropertyTypeDescriptor(
    _OriginEndpoint.LowLatencyHlsManifestConfiguration,
    "LowLatencyHlsManifestConfiguration",
)
OriginEndpoint.MssManifestConfiguration = PropertyTypeDescriptor(
    _OriginEndpoint.MssManifestConfiguration, "MssManifestConfiguration"
)
OriginEndpoint.Scte = PropertyTypeDescriptor(_OriginEndpoint.Scte, "Scte")
OriginEndpoint.ScteDash = PropertyTypeDescriptor(_OriginEndpoint.ScteDash, "ScteDash")
OriginEndpoint.ScteHls = PropertyTypeDescriptor(_OriginEndpoint.ScteHls, "ScteHls")
OriginEndpoint.Segment = PropertyTypeDescriptor(_OriginEndpoint.Segment, "Segment")
OriginEndpoint.SpekeKeyProvider = PropertyTypeDescriptor(
    _OriginEndpoint.SpekeKeyProvider, "SpekeKeyProvider"
)
OriginEndpoint.StartTag = PropertyTypeDescriptor(_OriginEndpoint.StartTag, "StartTag")
OriginEndpointPolicy.CdnAuthConfiguration = PropertyTypeDescriptor(
