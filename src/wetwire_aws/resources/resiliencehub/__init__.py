...
App.EventSubscription = PropertyTypeDescriptor(
    _App.EventSubscription, "EventSubscription"
)
App.PermissionModel = PropertyTypeDescriptor(_App.PermissionModel, "PermissionModel")
App.PhysicalResourceId = PropertyTypeDescriptor(
    _App.PhysicalResourceId, "PhysicalResourceId"
)
App.ResourceMapping = PropertyTypeDescriptor(_App.ResourceMapping, "ResourceMapping")
ResiliencyPolicy.FailurePolicy = PropertyTypeDescriptor(
    _ResiliencyPolicy.FailurePolicy, "FailurePolicy"
)
ResiliencyPolicy.PolicyMap = PropertyTypeDescriptor(
    _ResiliencyPolicy.PolicyMap, "PolicyMap"
)
