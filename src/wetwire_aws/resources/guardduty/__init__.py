...
Detector.CFNDataSourceConfigurations = PropertyTypeDescriptor(
    _Detector.CFNDataSourceConfigurations, "CFNDataSourceConfigurations"
)
Detector.CFNFeatureAdditionalConfiguration = PropertyTypeDescriptor(
    _Detector.CFNFeatureAdditionalConfiguration, "CFNFeatureAdditionalConfiguration"
)
Detector.CFNFeatureConfiguration = PropertyTypeDescriptor(
    _Detector.CFNFeatureConfiguration, "CFNFeatureConfiguration"
)
Detector.CFNKubernetesAuditLogsConfiguration = PropertyTypeDescriptor(
    _Detector.CFNKubernetesAuditLogsConfiguration, "CFNKubernetesAuditLogsConfiguration"
)
Detector.CFNKubernetesConfiguration = PropertyTypeDescriptor(
    _Detector.CFNKubernetesConfiguration, "CFNKubernetesConfiguration"
)
Detector.CFNMalwareProtectionConfiguration = PropertyTypeDescriptor(
    _Detector.CFNMalwareProtectionConfiguration, "CFNMalwareProtectionConfiguration"
)
Detector.CFNS3LogsConfiguration = PropertyTypeDescriptor(
    _Detector.CFNS3LogsConfiguration, "CFNS3LogsConfiguration"
)
Detector.CFNScanEc2InstanceWithFindingsConfiguration = PropertyTypeDescriptor(
    _Detector.CFNScanEc2InstanceWithFindingsConfiguration,
    "CFNScanEc2InstanceWithFindingsConfiguration",
)
Detector.TagItem = PropertyTypeDescriptor(_Detector.TagItem, "TagItem")
Filter.Condition = PropertyTypeDescriptor(_Filter.Condition, "Condition")
Filter.FindingCriteria = PropertyTypeDescriptor(
    _Filter.FindingCriteria, "FindingCriteria"
)
Filter.TagItem = PropertyTypeDescriptor(_Filter.TagItem, "TagItem")
IPSet.TagItem = PropertyTypeDescriptor(_IPSet.TagItem, "TagItem")
MalwareProtectionPlan.CFNActions = PropertyTypeDescriptor(
    _MalwareProtectionPlan.CFNActions, "CFNActions"
)
MalwareProtectionPlan.CFNProtectedResource = PropertyTypeDescriptor(
    _MalwareProtectionPlan.CFNProtectedResource, "CFNProtectedResource"
)
MalwareProtectionPlan.CFNStatusReasons = PropertyTypeDescriptor(
    _MalwareProtectionPlan.CFNStatusReasons, "CFNStatusReasons"
)
MalwareProtectionPlan.CFNTagging = PropertyTypeDescriptor(
    _MalwareProtectionPlan.CFNTagging, "CFNTagging"
)
MalwareProtectionPlan.S3Bucket = PropertyTypeDescriptor(
    _MalwareProtectionPlan.S3Bucket, "S3Bucket"
)
MalwareProtectionPlan.TagItem = PropertyTypeDescriptor(
    _MalwareProtectionPlan.TagItem, "TagItem"
)
PublishingDestination.CFNDestinationProperties = PropertyTypeDescriptor(
    _PublishingDestination.CFNDestinationProperties, "CFNDestinationProperties"
)
PublishingDestination.TagItem = PropertyTypeDescriptor(
    _PublishingDestination.TagItem, "TagItem"
)
ThreatEntitySet.TagItem = PropertyTypeDescriptor(_ThreatEntitySet.TagItem, "TagItem")
ThreatIntelSet.TagItem = PropertyTypeDescriptor(_ThreatIntelSet.TagItem, "TagItem")
TrustedEntitySet.TagItem = PropertyTypeDescriptor(_TrustedEntitySet.TagItem, "TagItem")
