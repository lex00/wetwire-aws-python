...
class ConnectionAlias(CloudFormationResource):
    ...
    ConnectionAliasAssociation = PropertyTypeDescriptor(
...
class Workspace(CloudFormationResource):
    ...
    root_volume_encryption_enabled: DslValue[bool] | None = None
    tags: list[DslValue[Tag]] = field(default_factory=list)
    user_volume_encryption_enabled: DslValue[bool] | None = None
    volume_encryption_key: DslValue[str] | None = None
    workspace_properties: DslValue[_Workspace.WorkspaceProperties] | None = None

    # PropertyType descriptors for nested GetAtt support
    WorkspaceProperties = PropertyTypeDescriptor(
...
class WorkspacesPool(CloudFormationResource):
    ...
    bundle_id: DslValue[str] | None = None
    capacity: DslValue[_WorkspacesPool.Capacity] | None = None
    directory_id: DslValue[str] | None = None
    pool_name: DslValue[str] | None = None
    application_settings: DslValue[_WorkspacesPool.ApplicationSettings] | None = None
    description: DslValue[str] | None = None
    running_mode: DslValue[str] | None = None
    timeout_settings: DslValue[_WorkspacesPool.TimeoutSettings] | None = None
    ...
    Capacity = PropertyTypeDescriptor(_WorkspacesPool.Capacity, "Capacity")
    TimeoutSettings = PropertyTypeDescriptor(
