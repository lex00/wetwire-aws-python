...
ConnectionAlias.ConnectionAliasAssociation = PropertyTypeDescriptor(
    _ConnectionAlias.ConnectionAliasAssociation, "ConnectionAliasAssociation"
)
Workspace.WorkspaceProperties = PropertyTypeDescriptor(
    _Workspace.WorkspaceProperties, "WorkspaceProperties"
)
WorkspacesPool.ApplicationSettings = PropertyTypeDescriptor(
    _WorkspacesPool.ApplicationSettings, "ApplicationSettings"
)
WorkspacesPool.Capacity = PropertyTypeDescriptor(_WorkspacesPool.Capacity, "Capacity")
WorkspacesPool.TimeoutSettings = PropertyTypeDescriptor(
    _WorkspacesPool.TimeoutSettings, "TimeoutSettings"
)
