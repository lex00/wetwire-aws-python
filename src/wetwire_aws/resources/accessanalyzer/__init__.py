...
class Analyzer(CloudFormationResource):
    ...
    analyzer_configuration: DslValue[_Analyzer.AnalyzerConfiguration] | None = None
    analyzer_name: DslValue[str] | None = None
    archive_rules: list[DslValue[_Analyzer.ArchiveRule]] = field(default_factory=list)
    ...
    AnalysisRule = PropertyTypeDescriptor(_Analyzer.AnalysisRule, "AnalysisRule")
    AnalysisRuleCriteria = PropertyTypeDescriptor(
        _Analyzer.AnalysisRuleCriteria, "AnalysisRuleCriteria"
    )
    AnalyzerConfiguration = PropertyTypeDescriptor(
        _Analyzer.AnalyzerConfiguration, "AnalyzerConfiguration"
    )
    ArchiveRule = PropertyTypeDescriptor(_Analyzer.ArchiveRule, "ArchiveRule")
    Filter = PropertyTypeDescriptor(_Analyzer.Filter, "Filter")
    InternalAccessAnalysisRule = PropertyTypeDescriptor(
        _Analyzer.InternalAccessAnalysisRule, "InternalAccessAnalysisRule"
    )
    InternalAccessAnalysisRuleCriteria = PropertyTypeDescriptor(
        _Analyzer.InternalAccessAnalysisRuleCriteria,
        "InternalAccessAnalysisRuleCriteria",
    )
    InternalAccessConfiguration = PropertyTypeDescriptor(
        _Analyzer.InternalAccessConfiguration, "InternalAccessConfiguration"
    )
    UnusedAccessConfiguration = PropertyTypeDescriptor(
