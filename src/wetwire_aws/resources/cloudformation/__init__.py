...
class CustomResource(CloudFormationResource):
    ...
    service_token: DslValue[str] | None = None
    service_timeout: DslValue[int] | None = None
...
class GuardHook(CloudFormationResource):
    ...
    failure_mode: DslValue[str] | None = None
    hook_status: DslValue[str] | None = None
    rule_location: DslValue[_GuardHook.S3Location] | None = None
    target_operations: list[DslValue[str]] = field(default_factory=list)
    log_bucket: DslValue[str] | None = None
    options: DslValue[_GuardHook.Options] | None = None
    stack_filters: DslValue[_GuardHook.StackFilters] | None = None
    target_filters: DslValue[_GuardHook.TargetFilters] | None = None

    # GetAtt attributes
    HOOKARN: ClassVar[str] = "HookArn"

    # PropertyType descriptors for nested GetAtt support
    HookTarget = PropertyTypeDescriptor(_GuardHook.HookTarget, "HookTarget")
    Options = PropertyTypeDescriptor(_GuardHook.Options, "Options")
    S3Location = PropertyTypeDescriptor(_GuardHook.S3Location, "S3Location")
    StackFilters = PropertyTypeDescriptor(_GuardHook.StackFilters, "StackFilters")
    StackNames = PropertyTypeDescriptor(_GuardHook.StackNames, "StackNames")
    StackRoles = PropertyTypeDescriptor(_GuardHook.StackRoles, "StackRoles")
    TargetFilters = PropertyTypeDescriptor(_GuardHook.TargetFilters, "TargetFilters")
...
class HookDefaultVersion(CloudFormationResource):
    ...
    type_version_arn: DslValue[str] | None = None
...
class HookTypeConfig(CloudFormationResource):
    ...
    configuration_alias: DslValue[str] | None = None
    type_arn: DslValue[str] | None = None
    type_name: DslValue[str] | None = None
...
class HookVersion(CloudFormationResource):
    ...
    schema_handler_package: DslValue[str] | None = None
    type_name: DslValue[str] | None = None
    execution_role_arn: DslValue[str] | None = None
    logging_config: DslValue[_HookVersion.LoggingConfig] | None = None
    ...
    # PropertyType descriptors for nested GetAtt support
    LoggingConfig = PropertyTypeDescriptor(_HookVersion.LoggingConfig, "LoggingConfig")
...
class LambdaHook(CloudFormationResource):
    ...
    failure_mode: DslValue[str] | None = None
    hook_status: DslValue[str] | None = None
    lambda_function: DslValue[str] | None = None
    target_operations: list[DslValue[str]] = field(default_factory=list)
    stack_filters: DslValue[_LambdaHook.StackFilters] | None = None
    target_filters: DslValue[_LambdaHook.TargetFilters] | None = None

    # GetAtt attributes
    HOOKARN: ClassVar[str] = "HookArn"

    # PropertyType descriptors for nested GetAtt support
    HookTarget = PropertyTypeDescriptor(_LambdaHook.HookTarget, "HookTarget")
    StackFilters = PropertyTypeDescriptor(_LambdaHook.StackFilters, "StackFilters")
    StackNames = PropertyTypeDescriptor(_LambdaHook.StackNames, "StackNames")
    StackRoles = PropertyTypeDescriptor(_LambdaHook.StackRoles, "StackRoles")
    TargetFilters = PropertyTypeDescriptor(_LambdaHook.TargetFilters, "TargetFilters")
...
class ModuleDefaultVersion(CloudFormationResource):
    ...
    module_name: DslValue[str] | None = None
    version_id: DslValue[str] | None = None
...
class ModuleVersion(CloudFormationResource):
    ...
    module_name: DslValue[str] | None = None
    module_package: DslValue[str] | None = None
...
class PublicTypeVersion(CloudFormationResource):
    ...
    arn: DslValue[str] | None = None
    log_delivery_bucket: DslValue[str] | None = None
    public_version_number: DslValue[str] | None = None
...
class Publisher(CloudFormationResource):
    ...
    accept_terms_and_conditions: DslValue[bool] | None = None
...
class ResourceVersion(CloudFormationResource):
    ...
    type_name: DslValue[str] | None = None
    execution_role_arn: DslValue[str] | None = None
    logging_config: DslValue[_ResourceVersion.LoggingConfig] | None = None
...
class Stack(CloudFormationResource):
    ...
    notification_ar_ns: list[DslValue[str]] = field(default_factory=list)
...
class StackSet(CloudFormationResource):
    ...
    permission_model: DslValue[str] | None = None
    stack_set_name: DslValue[str] | None = None
    administration_role_arn: DslValue[str] | None = None
    auto_deployment: DslValue[_StackSet.AutoDeployment] | None = None
    call_as: DslValue[str] | None = None
    capabilities: list[DslValue[str]] = field(default_factory=list)
    description: DslValue[str] | None = None
    execution_role_name: DslValue[str] | None = None
    managed_execution: DslValue[_StackSet.ManagedExecution] | None = None
    operation_preferences: DslValue[_StackSet.OperationPreferences] | None = None
    parameters: list[DslValue[_StackSet.Parameter]] = field(default_factory=list)
    stack_instances_group: list[DslValue[_StackSet.StackInstances]] = field(
    ...
    # PropertyType descriptors for nested GetAtt support
    AutoDeployment = PropertyTypeDescriptor(_StackSet.AutoDeployment, "AutoDeployment")
    DeploymentTargets = PropertyTypeDescriptor(
        _StackSet.DeploymentTargets, "DeploymentTargets"
    )
    ManagedExecution = PropertyTypeDescriptor(
        _StackSet.ManagedExecution, "ManagedExecution"
    )
    OperationPreferences = PropertyTypeDescriptor(
        _StackSet.OperationPreferences, "OperationPreferences"
    )
    Parameter = PropertyTypeDescriptor(_StackSet.Parameter, "Parameter")
    StackInstances = PropertyTypeDescriptor(_StackSet.StackInstances, "StackInstances")
...
class TypeActivation(CloudFormationResource):
    ...
    auto_update: DslValue[bool] | None = None
    execution_role_arn: DslValue[str] | None = None
    logging_config: DslValue[_TypeActivation.LoggingConfig] | None = None
    major_version: DslValue[str] | None = None
    public_type_arn: DslValue[str] | None = None
    publisher_id: DslValue[str] | None = None
    type_: DslValue[str] | None = None
    type_name: DslValue[str] | None = None
    type_name_alias: DslValue[str] | None = None
    version_bump: DslValue[str] | None = None
