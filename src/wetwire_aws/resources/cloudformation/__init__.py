...
GuardHook.HookTarget = _GuardHook.HookTarget
GuardHook.Options = _GuardHook.Options
GuardHook.S3Location = _GuardHook.S3Location
GuardHook.StackFilters = _GuardHook.StackFilters
GuardHook.StackNames = _GuardHook.StackNames
GuardHook.StackRoles = _GuardHook.StackRoles
GuardHook.TargetFilters = _GuardHook.TargetFilters
HookVersion.LoggingConfig = _HookVersion.LoggingConfig
LambdaHook.HookTarget = _LambdaHook.HookTarget
LambdaHook.StackFilters = _LambdaHook.StackFilters
LambdaHook.StackNames = _LambdaHook.StackNames
LambdaHook.StackRoles = _LambdaHook.StackRoles
LambdaHook.TargetFilters = _LambdaHook.TargetFilters
ResourceVersion.LoggingConfig = _ResourceVersion.LoggingConfig
StackSet.AutoDeployment = _StackSet.AutoDeployment
StackSet.DeploymentTargets = _StackSet.DeploymentTargets
StackSet.ManagedExecution = _StackSet.ManagedExecution
StackSet.OperationPreferences = _StackSet.OperationPreferences
StackSet.Parameter = _StackSet.Parameter
StackSet.StackInstances = _StackSet.StackInstances
TypeActivation.LoggingConfig = _TypeActivation.LoggingConfig
