...
Application.AppConfig = PropertyTypeDescriptor(_Application.AppConfig, "AppConfig")
Application.DataSource = PropertyTypeDescriptor(_Application.DataSource, "DataSource")
Application.IamIdentityCenterOptions = PropertyTypeDescriptor(
    _Application.IamIdentityCenterOptions, "IamIdentityCenterOptions"
)
Domain.AIMLOptions = PropertyTypeDescriptor(_Domain.AIMLOptions, "AIMLOptions")
Domain.AdvancedSecurityOptionsInput = PropertyTypeDescriptor(
    _Domain.AdvancedSecurityOptionsInput, "AdvancedSecurityOptionsInput"
)
Domain.ClusterConfig = PropertyTypeDescriptor(_Domain.ClusterConfig, "ClusterConfig")
Domain.CognitoOptions = PropertyTypeDescriptor(_Domain.CognitoOptions, "CognitoOptions")
Domain.ColdStorageOptions = PropertyTypeDescriptor(
    _Domain.ColdStorageOptions, "ColdStorageOptions"
)
Domain.DomainEndpointOptions = PropertyTypeDescriptor(
    _Domain.DomainEndpointOptions, "DomainEndpointOptions"
)
Domain.EBSOptions = PropertyTypeDescriptor(_Domain.EBSOptions, "EBSOptions")
Domain.EncryptionAtRestOptions = PropertyTypeDescriptor(
    _Domain.EncryptionAtRestOptions, "EncryptionAtRestOptions"
)
Domain.IAMFederationOptions = PropertyTypeDescriptor(
    _Domain.IAMFederationOptions, "IAMFederationOptions"
)
Domain.IdentityCenterOptions = PropertyTypeDescriptor(
    _Domain.IdentityCenterOptions, "IdentityCenterOptions"
)
Domain.Idp = PropertyTypeDescriptor(_Domain.Idp, "Idp")
Domain.JWTOptions = PropertyTypeDescriptor(_Domain.JWTOptions, "JWTOptions")
Domain.LogPublishingOption = PropertyTypeDescriptor(
    _Domain.LogPublishingOption, "LogPublishingOption"
)
Domain.MasterUserOptions = PropertyTypeDescriptor(
    _Domain.MasterUserOptions, "MasterUserOptions"
)
Domain.NodeConfig = PropertyTypeDescriptor(_Domain.NodeConfig, "NodeConfig")
Domain.NodeOption = PropertyTypeDescriptor(_Domain.NodeOption, "NodeOption")
Domain.NodeToNodeEncryptionOptions = PropertyTypeDescriptor(
    _Domain.NodeToNodeEncryptionOptions, "NodeToNodeEncryptionOptions"
)
Domain.OffPeakWindow = PropertyTypeDescriptor(_Domain.OffPeakWindow, "OffPeakWindow")
Domain.OffPeakWindowOptions = PropertyTypeDescriptor(
    _Domain.OffPeakWindowOptions, "OffPeakWindowOptions"
)
Domain.S3VectorsEngine = PropertyTypeDescriptor(
    _Domain.S3VectorsEngine, "S3VectorsEngine"
)
Domain.SAMLOptions = PropertyTypeDescriptor(_Domain.SAMLOptions, "SAMLOptions")
Domain.ServiceSoftwareOptions = PropertyTypeDescriptor(
    _Domain.ServiceSoftwareOptions, "ServiceSoftwareOptions"
)
Domain.SnapshotOptions = PropertyTypeDescriptor(
    _Domain.SnapshotOptions, "SnapshotOptions"
)
Domain.SoftwareUpdateOptions = PropertyTypeDescriptor(
    _Domain.SoftwareUpdateOptions, "SoftwareUpdateOptions"
)
Domain.VPCOptions = PropertyTypeDescriptor(_Domain.VPCOptions, "VPCOptions")
Domain.WindowStartTime = PropertyTypeDescriptor(
    _Domain.WindowStartTime, "WindowStartTime"
)
Domain.ZoneAwarenessConfig = PropertyTypeDescriptor(
    _Domain.ZoneAwarenessConfig, "ZoneAwarenessConfig"
)
