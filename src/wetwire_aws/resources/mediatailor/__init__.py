...
Channel.DashPlaylistSettings = _Channel.DashPlaylistSettings
Channel.HlsPlaylistSettings = _Channel.HlsPlaylistSettings
Channel.LogConfigurationForChannel = _Channel.LogConfigurationForChannel
Channel.RequestOutputItem = _Channel.RequestOutputItem
Channel.SlateSource = _Channel.SlateSource
Channel.TimeShiftConfiguration = _Channel.TimeShiftConfiguration
LiveSource.HttpPackageConfiguration = _LiveSource.HttpPackageConfiguration
PlaybackConfiguration.AdConditioningConfiguration = (
    _PlaybackConfiguration.AdConditioningConfiguration
)
PlaybackConfiguration.AdMarkerPassthrough = _PlaybackConfiguration.AdMarkerPassthrough
PlaybackConfiguration.AdsInteractionLog = _PlaybackConfiguration.AdsInteractionLog
PlaybackConfiguration.AvailSuppression = _PlaybackConfiguration.AvailSuppression
PlaybackConfiguration.Bumper = _PlaybackConfiguration.Bumper
PlaybackConfiguration.CdnConfiguration = _PlaybackConfiguration.CdnConfiguration
PlaybackConfiguration.DashConfiguration = _PlaybackConfiguration.DashConfiguration
PlaybackConfiguration.HlsConfiguration = _PlaybackConfiguration.HlsConfiguration
PlaybackConfiguration.LivePreRollConfiguration = (
    _PlaybackConfiguration.LivePreRollConfiguration
)
PlaybackConfiguration.LogConfiguration = _PlaybackConfiguration.LogConfiguration
PlaybackConfiguration.ManifestProcessingRules = (
    _PlaybackConfiguration.ManifestProcessingRules
)
PlaybackConfiguration.ManifestServiceInteractionLog = (
    _PlaybackConfiguration.ManifestServiceInteractionLog
)
SourceLocation.AccessConfiguration = _SourceLocation.AccessConfiguration
SourceLocation.DefaultSegmentDeliveryConfiguration = (
    _SourceLocation.DefaultSegmentDeliveryConfiguration
)
SourceLocation.HttpConfiguration = _SourceLocation.HttpConfiguration
SourceLocation.SecretsManagerAccessTokenConfiguration = (
    _SourceLocation.SecretsManagerAccessTokenConfiguration
)
SourceLocation.SegmentDeliveryConfiguration = (
    _SourceLocation.SegmentDeliveryConfiguration
)
VodSource.HttpPackageConfiguration = _VodSource.HttpPackageConfiguration
