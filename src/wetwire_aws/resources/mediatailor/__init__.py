...
class Channel(CloudFormationResource):
    ...
    outputs: list[DslValue[_Channel.RequestOutputItem]] = field(default_factory=list)
    playback_mode: DslValue[str] | None = None
    audiences: list[DslValue[str]] = field(default_factory=list)
    filler_slate: DslValue[_Channel.SlateSource] | None = None
    log_configuration: DslValue[_Channel.LogConfigurationForChannel] | None = None
    tags: list[DslValue[Tag]] = field(default_factory=list)
    tier: DslValue[str] | None = None
    time_shift_configuration: DslValue[_Channel.TimeShiftConfiguration] | None = None

    # GetAtt attributes
    ARN: ClassVar[str] = "Arn"

    # PropertyType descriptors for nested GetAtt support
    DashPlaylistSettings = PropertyTypeDescriptor(
        _Channel.DashPlaylistSettings, "DashPlaylistSettings"
    )
    HlsPlaylistSettings = PropertyTypeDescriptor(
        _Channel.HlsPlaylistSettings, "HlsPlaylistSettings"
    )
    LogConfigurationForChannel = PropertyTypeDescriptor(
        _Channel.LogConfigurationForChannel, "LogConfigurationForChannel"
    )
    RequestOutputItem = PropertyTypeDescriptor(
        _Channel.RequestOutputItem, "RequestOutputItem"
    )
    SlateSource = PropertyTypeDescriptor(_Channel.SlateSource, "SlateSource")
    TimeShiftConfiguration = PropertyTypeDescriptor(
...
class LiveSource(CloudFormationResource):
    ...
    http_package_configurations: list[
        DslValue[_LiveSource.HttpPackageConfiguration]
    ] = field(default_factory=list)
    live_source_name: DslValue[str] | None = None
    ...
    # PropertyType descriptors for nested GetAtt support
    HttpPackageConfiguration = PropertyTypeDescriptor(
...
class PlaybackConfiguration(CloudFormationResource):
    ...
    video_content_source_url: DslValue[str] | None = None
    ad_conditioning_configuration: (
        DslValue[_PlaybackConfiguration.AdConditioningConfiguration] | None
    ) = None
    ad_decision_server_configuration: (
        DslValue[_PlaybackConfiguration.AdDecisionServerConfiguration] | None
    ) = None
    avail_suppression: DslValue[_PlaybackConfiguration.AvailSuppression] | None = None
    bumper: DslValue[_PlaybackConfiguration.Bumper] | None = None
    cdn_configuration: DslValue[_PlaybackConfiguration.CdnConfiguration] | None = None
    configuration_aliases: dict[str, DslValue[dict[str, Any]]] = field(
        default_factory=dict
    )
    dash_configuration: DslValue[_PlaybackConfiguration.DashConfiguration] | None = None
    hls_configuration: DslValue[_PlaybackConfiguration.HlsConfiguration] | None = None
    insertion_mode: DslValue[str] | None = None
    live_pre_roll_configuration: (
        DslValue[_PlaybackConfiguration.LivePreRollConfiguration] | None
    ) = None
    log_configuration: DslValue[_PlaybackConfiguration.LogConfiguration] | None = None
    manifest_processing_rules: (
        DslValue[_PlaybackConfiguration.ManifestProcessingRules] | None
    ) = None
    personalization_threshold_seconds: DslValue[int] | None = None
    slate_ad_url: DslValue[str] | None = None
    tags: list[DslValue[Tag]] = field(default_factory=list)
    transcode_profile_name: DslValue[str] | None = None
    ...
    # PropertyType descriptors for nested GetAtt support
    AdConditioningConfiguration = PropertyTypeDescriptor(
        _PlaybackConfiguration.AdConditioningConfiguration,
        "AdConditioningConfiguration",
    )
    AdDecisionServerConfiguration = PropertyTypeDescriptor(
        _PlaybackConfiguration.AdDecisionServerConfiguration,
        "AdDecisionServerConfiguration",
    )
    AdMarkerPassthrough = PropertyTypeDescriptor(
        _PlaybackConfiguration.AdMarkerPassthrough, "AdMarkerPassthrough"
    )
    AdsInteractionLog = PropertyTypeDescriptor(
        _PlaybackConfiguration.AdsInteractionLog, "AdsInteractionLog"
    )
    AvailSuppression = PropertyTypeDescriptor(
        _PlaybackConfiguration.AvailSuppression, "AvailSuppression"
    )
    Bumper = PropertyTypeDescriptor(_PlaybackConfiguration.Bumper, "Bumper")
    CdnConfiguration = PropertyTypeDescriptor(
        _PlaybackConfiguration.CdnConfiguration, "CdnConfiguration"
    )
    DashConfiguration = PropertyTypeDescriptor(
    ...
    HttpRequest = PropertyTypeDescriptor(
        _PlaybackConfiguration.HttpRequest, "HttpRequest"
    )
    LivePreRollConfiguration = PropertyTypeDescriptor(
    ...
    ManifestProcessingRules = PropertyTypeDescriptor(
        _PlaybackConfiguration.ManifestProcessingRules, "ManifestProcessingRules"
    )
    ManifestServiceInteractionLog = PropertyTypeDescriptor(
...
class SourceLocation(CloudFormationResource):
    ...
    http_configuration: DslValue[_SourceLocation.HttpConfiguration] | None = None
    source_location_name: DslValue[str] | None = None
    access_configuration: DslValue[_SourceLocation.AccessConfiguration] | None = None
    default_segment_delivery_configuration: (
        DslValue[_SourceLocation.DefaultSegmentDeliveryConfiguration] | None
    ) = None
    segment_delivery_configurations: list[
        DslValue[_SourceLocation.SegmentDeliveryConfiguration]
    ] = field(default_factory=list)
    tags: list[DslValue[Tag]] = field(default_factory=list)
    ...
    # PropertyType descriptors for nested GetAtt support
    AccessConfiguration = PropertyTypeDescriptor(
        _SourceLocation.AccessConfiguration, "AccessConfiguration"
    )
    DefaultSegmentDeliveryConfiguration = PropertyTypeDescriptor(
        _SourceLocation.DefaultSegmentDeliveryConfiguration,
        "DefaultSegmentDeliveryConfiguration",
    )
    HttpConfiguration = PropertyTypeDescriptor(
        _SourceLocation.HttpConfiguration, "HttpConfiguration"
    )
    SecretsManagerAccessTokenConfiguration = PropertyTypeDescriptor(
        _SourceLocation.SecretsManagerAccessTokenConfiguration,
        "SecretsManagerAccessTokenConfiguration",
    )
    SegmentDeliveryConfiguration = PropertyTypeDescriptor(
...
class VodSource(CloudFormationResource):
    ...
    http_package_configurations: list[DslValue[_VodSource.HttpPackageConfiguration]] = (
        field(default_factory=list)
    )
    source_location_name: DslValue[str] | None = None
