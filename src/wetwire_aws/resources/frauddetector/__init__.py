...
class Detector(CloudFormationResource):
    ...
    event_type: DslValue[_Detector.EventType] | None = None
    rules: list[DslValue[_Detector.Rule]] = field(default_factory=list)
    associated_models: list[DslValue[_Detector.Model]] = field(default_factory=list)
    description: DslValue[str] | None = None
    detector_version_status: DslValue[str] | None = None
    rule_execution_mode: DslValue[str] | None = None
    ...
    EntityType = PropertyTypeDescriptor(_Detector.EntityType, "EntityType")
    EventType = PropertyTypeDescriptor(_Detector.EventType, "EventType")
    EventVariable = PropertyTypeDescriptor(_Detector.EventVariable, "EventVariable")
    Label = PropertyTypeDescriptor(_Detector.Label, "Label")
    Model = PropertyTypeDescriptor(_Detector.Model, "Model")
    Outcome = PropertyTypeDescriptor(_Detector.Outcome, "Outcome")
    Rule = PropertyTypeDescriptor(_Detector.Rule, "Rule")
...
class EventType(CloudFormationResource):
    ...
    entity_types: list[DslValue[_EventType.EntityType]] = field(default_factory=list)
    event_variables: list[DslValue[_EventType.EventVariable]] = field(
        default_factory=list
    )
    labels: list[DslValue[_EventType.Label]] = field(default_factory=list)
    name: DslValue[str] | None = None
    description: DslValue[str] | None = None
    tags: list[DslValue[Tag]] = field(default_factory=list)
    ...
    # PropertyType descriptors for nested GetAtt support
    EntityType = PropertyTypeDescriptor(_EventType.EntityType, "EntityType")
    EventVariable = PropertyTypeDescriptor(_EventType.EventVariable, "EventVariable")
    Label = PropertyTypeDescriptor(_EventType.Label, "Label")
...
class List(CloudFormationResource):
    ...
    name: DslValue[str] | None = None
    description: DslValue[str] | None = None
    elements: list[DslValue[str]] = field(default_factory=list)
    tags: list[DslValue[Tag]] = field(default_factory=list)
