...
class PredictiveScalingCustomizedCapacityMetric(PropertyType):
    metric_data_queries: list[PredictiveScalingMetricDataQuery] = field(
...
class PredictiveScalingMetric(PropertyType):
    dimensions: list[PredictiveScalingMetricDimension] = field(default_factory=list)
    metric_name: str | None = None
    namespace: str | None = None
...
class PredictiveScalingMetricDataQuery(PropertyType):
    ...
    id: str | None = None
    label: str | None = None
    metric_stat: PredictiveScalingMetricStat | None = None
...
class PredictiveScalingMetricStat(PropertyType):
    metric: PredictiveScalingMetric | None = None
    stat: str | None = None
    unit: str | None = None
...
class TargetTrackingMetric(PropertyType):
    dimensions: list[TargetTrackingMetricDimension] = field(default_factory=list)
    metric_name: str | None = None
    namespace: str | None = None
...
class TargetTrackingMetricStat(PropertyType):
    metric: TargetTrackingMetric | None = None
    stat: str | None = None
    unit: str | None = None
