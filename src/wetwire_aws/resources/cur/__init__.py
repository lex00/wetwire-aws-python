...
class ReportDefinition(CloudFormationResource):
    ...
    refresh_closed_reports: DslValue[bool] | None = None
    report_name: DslValue[str] | None = None
    report_versioning: DslValue[str] | None = None
    ...
    additional_artifacts: list[DslValue[str]] = field(default_factory=list)
    additional_schema_elements: list[DslValue[str]] = field(default_factory=list)
