...
PackageGroup.OriginConfiguration = PropertyTypeDescriptor(
    _PackageGroup.OriginConfiguration, "OriginConfiguration"
)
PackageGroup.RestrictionType = PropertyTypeDescriptor(
    _PackageGroup.RestrictionType, "RestrictionType"
)
PackageGroup.Restrictions = PropertyTypeDescriptor(
    _PackageGroup.Restrictions, "Restrictions"
)
