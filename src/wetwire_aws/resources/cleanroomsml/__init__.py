...
TrainingDataset.ColumnSchema = PropertyTypeDescriptor(
    _TrainingDataset.ColumnSchema, "ColumnSchema"
)
TrainingDataset.DataSource = PropertyTypeDescriptor(
    _TrainingDataset.DataSource, "DataSource"
)
TrainingDataset.Dataset = PropertyTypeDescriptor(_TrainingDataset.Dataset, "Dataset")
TrainingDataset.DatasetInputConfig = PropertyTypeDescriptor(
    _TrainingDataset.DatasetInputConfig, "DatasetInputConfig"
)
TrainingDataset.GlueDataSource = PropertyTypeDescriptor(
    _TrainingDataset.GlueDataSource, "GlueDataSource"
)
