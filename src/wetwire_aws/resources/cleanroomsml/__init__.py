...
class TrainingDataset(CloudFormationResource):
    ...
    training_data: list[DslValue[_TrainingDataset.Dataset]] = field(
    ...
    ColumnSchema = PropertyTypeDescriptor(_TrainingDataset.ColumnSchema, "ColumnSchema")
    DataSource = PropertyTypeDescriptor(_TrainingDataset.DataSource, "DataSource")
    Dataset = PropertyTypeDescriptor(_TrainingDataset.Dataset, "Dataset")
    DatasetInputConfig = PropertyTypeDescriptor(
        _TrainingDataset.DatasetInputConfig, "DatasetInputConfig"
    )
    GlueDataSource = PropertyTypeDescriptor(
