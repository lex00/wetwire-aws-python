...
class BillingView(CloudFormationResource):
    ...
    source_views: list[DslValue[str]] = field(default_factory=list)
    data_filter_expression: DslValue[_BillingView.DataFilterExpression] | None = None
    ...
    DataFilterExpression = PropertyTypeDescriptor(
        _BillingView.DataFilterExpression, "DataFilterExpression"
    )
    Dimensions = PropertyTypeDescriptor(_BillingView.Dimensions, "Dimensions")
    Tags = PropertyTypeDescriptor(_BillingView.Tags, "Tags")
    TimeRange = PropertyTypeDescriptor(_BillingView.TimeRange, "TimeRange")
