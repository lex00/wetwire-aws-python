...
Fleet.ComputeConfiguration = _Fleet.ComputeConfiguration
Fleet.FleetProxyRule = _Fleet.FleetProxyRule
Fleet.ProxyConfiguration = _Fleet.ProxyConfiguration
Fleet.ScalingConfigurationInput = _Fleet.ScalingConfigurationInput
Fleet.TargetTrackingScalingConfiguration = _Fleet.TargetTrackingScalingConfiguration
Fleet.VpcConfig = _Fleet.VpcConfig
Project.Artifacts = _Project.Artifacts
Project.BatchRestrictions = _Project.BatchRestrictions
Project.BuildStatusConfig = _Project.BuildStatusConfig
Project.CloudWatchLogsConfig = _Project.CloudWatchLogsConfig
Project.DockerServer = _Project.DockerServer
Project.Environment = _Project.Environment
Project.EnvironmentVariable = _Project.EnvironmentVariable
Project.FilterGroup = _Project.FilterGroup
Project.GitSubmodulesConfig = _Project.GitSubmodulesConfig
Project.LogsConfig = _Project.LogsConfig
Project.ProjectBuildBatchConfig = _Project.ProjectBuildBatchConfig
Project.ProjectCache = _Project.ProjectCache
Project.ProjectFileSystemLocation = _Project.ProjectFileSystemLocation
Project.ProjectFleet = _Project.ProjectFleet
Project.ProjectSourceVersion = _Project.ProjectSourceVersion
Project.ProjectTriggers = _Project.ProjectTriggers
Project.PullRequestBuildPolicy = _Project.PullRequestBuildPolicy
Project.RegistryCredential = _Project.RegistryCredential
Project.S3LogsConfig = _Project.S3LogsConfig
Project.ScopeConfiguration = _Project.ScopeConfiguration
Project.Source = _Project.Source
Project.SourceAuth = _Project.SourceAuth
Project.VpcConfig = _Project.VpcConfig
Project.WebhookFilter = _Project.WebhookFilter
ReportGroup.ReportExportConfig = _ReportGroup.ReportExportConfig
ReportGroup.S3ReportExportConfig = _ReportGroup.S3ReportExportConfig
