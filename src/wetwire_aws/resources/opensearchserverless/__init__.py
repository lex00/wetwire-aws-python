...
Index.IndexSettings = _Index.IndexSettings
Index.Mappings = _Index.Mappings
Index.Method = _Index.Method
Index.Parameters = _Index.Parameters
Index.PropertyMapping = _Index.PropertyMapping
SecurityConfig.IamFederationConfigOptions = _SecurityConfig.IamFederationConfigOptions
SecurityConfig.IamIdentityCenterConfigOptions = (
    _SecurityConfig.IamIdentityCenterConfigOptions
)
SecurityConfig.SamlConfigOptions = _SecurityConfig.SamlConfigOptions
