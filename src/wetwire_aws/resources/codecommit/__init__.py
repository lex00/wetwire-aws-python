...
Repository.Code = PropertyTypeDescriptor(_Repository.Code, "Code")
Repository.RepositoryTrigger = PropertyTypeDescriptor(
    _Repository.RepositoryTrigger, "RepositoryTrigger"
)
Repository.S3 = PropertyTypeDescriptor(_Repository.S3, "S3")
