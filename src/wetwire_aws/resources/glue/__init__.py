...
Classifier.CsvClassifier = _Classifier.CsvClassifier
Classifier.GrokClassifier = _Classifier.GrokClassifier
Classifier.JsonClassifier = _Classifier.JsonClassifier
Classifier.XMLClassifier = _Classifier.XMLClassifier
...
Connection.ConnectionInput = _Connection.ConnectionInput
Connection.OAuth2ClientApplication = _Connection.OAuth2ClientApplication
Connection.OAuth2Credentials = _Connection.OAuth2Credentials
Connection.OAuth2PropertiesInput = _Connection.OAuth2PropertiesInput
Connection.PhysicalConnectionRequirements = _Connection.PhysicalConnectionRequirements
Crawler.CatalogTarget = _Crawler.CatalogTarget
Crawler.DeltaTarget = _Crawler.DeltaTarget
Crawler.DynamoDBTarget = _Crawler.DynamoDBTarget
Crawler.HudiTarget = _Crawler.HudiTarget
Crawler.IcebergTarget = _Crawler.IcebergTarget
Crawler.JdbcTarget = _Crawler.JdbcTarget
Crawler.LakeFormationConfiguration = _Crawler.LakeFormationConfiguration
Crawler.MongoDBTarget = _Crawler.MongoDBTarget
Crawler.RecrawlPolicy = _Crawler.RecrawlPolicy
Crawler.S3Target = _Crawler.S3Target
Crawler.Schedule = _Crawler.Schedule
Crawler.SchemaChangePolicy = _Crawler.SchemaChangePolicy
Crawler.Targets = _Crawler.Targets
...
DataCatalogEncryptionSettings.EncryptionAtRest = (
    _DataCatalogEncryptionSettings.EncryptionAtRest
)
DataQualityRuleset.DataQualityTargetTable = _DataQualityRuleset.DataQualityTargetTable
Database.DataLakePrincipal = _Database.DataLakePrincipal
Database.DatabaseIdentifier = _Database.DatabaseIdentifier
Database.DatabaseInput = _Database.DatabaseInput
Database.FederatedDatabase = _Database.FederatedDatabase
Database.PrincipalPrivileges = _Database.PrincipalPrivileges
Integration.IntegrationConfig = _Integration.IntegrationConfig
IntegrationResourceProperty.SourceProcessingProperties = (
    _IntegrationResourceProperty.SourceProcessingProperties
)
IntegrationResourceProperty.TargetProcessingProperties = (
    _IntegrationResourceProperty.TargetProcessingProperties
)
Job.ConnectionsList = _Job.ConnectionsList
Job.ExecutionProperty = _Job.ExecutionProperty
Job.JobCommand = _Job.JobCommand
Job.NotificationProperty = _Job.NotificationProperty
MLTransform.FindMatchesParameters = _MLTransform.FindMatchesParameters
MLTransform.GlueTables = _MLTransform.GlueTables
MLTransform.InputRecordTables = _MLTransform.InputRecordTables
MLTransform.MLUserDataEncryption = _MLTransform.MLUserDataEncryption
MLTransform.TransformEncryption = _MLTransform.TransformEncryption
MLTransform.TransformParameters = _MLTransform.TransformParameters
Partition.Column = _Partition.Column
Partition.Order = _Partition.Order
Partition.PartitionInput = _Partition.PartitionInput
Partition.SchemaId = _Partition.SchemaId
Partition.SchemaReference = _Partition.SchemaReference
Partition.SerdeInfo = _Partition.SerdeInfo
Partition.SkewedInfo = _Partition.SkewedInfo
Partition.StorageDescriptor = _Partition.StorageDescriptor
Schema.Registry = _Schema.Registry
Schema.SchemaVersion = _Schema.SchemaVersion
SchemaVersion.Schema = _SchemaVersion.Schema
SecurityConfiguration.CloudWatchEncryption = _SecurityConfiguration.CloudWatchEncryption
SecurityConfiguration.EncryptionConfiguration = (
    _SecurityConfiguration.EncryptionConfiguration
)
SecurityConfiguration.JobBookmarksEncryption = (
    _SecurityConfiguration.JobBookmarksEncryption
)
SecurityConfiguration.S3Encryption = _SecurityConfiguration.S3Encryption
SecurityConfiguration.S3Encryptions = _SecurityConfiguration.S3Encryptions
Table.Column = _Table.Column
Table.IcebergInput = _Table.IcebergInput
Table.MetadataOperation = _Table.MetadataOperation
Table.OpenTableFormatInput = _Table.OpenTableFormatInput
Table.Order = _Table.Order
Table.SchemaId = _Table.SchemaId
Table.SchemaReference = _Table.SchemaReference
Table.SerdeInfo = _Table.SerdeInfo
Table.SkewedInfo = _Table.SkewedInfo
Table.StorageDescriptor = _Table.StorageDescriptor
Table.TableIdentifier = _Table.TableIdentifier
Table.TableInput = _Table.TableInput
TableOptimizer.IcebergConfiguration = _TableOptimizer.IcebergConfiguration
TableOptimizer.IcebergRetentionConfiguration = (
    _TableOptimizer.IcebergRetentionConfiguration
)
TableOptimizer.OrphanFileDeletionConfiguration = (
    _TableOptimizer.OrphanFileDeletionConfiguration
)
TableOptimizer.RetentionConfiguration = _TableOptimizer.RetentionConfiguration
TableOptimizer.TableOptimizerConfiguration = _TableOptimizer.TableOptimizerConfiguration
TableOptimizer.VpcConfiguration = _TableOptimizer.VpcConfiguration
Trigger.Action = _Trigger.Action
Trigger.Condition = _Trigger.Condition
Trigger.EventBatchingCondition = _Trigger.EventBatchingCondition
Trigger.NotificationProperty = _Trigger.NotificationProperty
Trigger.Predicate = _Trigger.Predicate
UsageProfile.ConfigurationObject = _UsageProfile.ConfigurationObject
UsageProfile.ProfileConfiguration = _UsageProfile.ProfileConfiguration
