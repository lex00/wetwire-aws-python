...
DataRepositoryAssociation.AutoExportPolicy = _DataRepositoryAssociation.AutoExportPolicy
DataRepositoryAssociation.AutoImportPolicy = _DataRepositoryAssociation.AutoImportPolicy
DataRepositoryAssociation.S3 = _DataRepositoryAssociation.S3
FileSystem.AuditLogConfiguration = _FileSystem.AuditLogConfiguration
FileSystem.ClientConfigurations = _FileSystem.ClientConfigurations
FileSystem.DataReadCacheConfiguration = _FileSystem.DataReadCacheConfiguration
FileSystem.DiskIopsConfiguration = _FileSystem.DiskIopsConfiguration
FileSystem.LustreConfiguration = _FileSystem.LustreConfiguration
FileSystem.MetadataConfiguration = _FileSystem.MetadataConfiguration
FileSystem.NfsExports = _FileSystem.NfsExports
FileSystem.OntapConfiguration = _FileSystem.OntapConfiguration
FileSystem.OpenZFSConfiguration = _FileSystem.OpenZFSConfiguration
FileSystem.ReadCacheConfiguration = _FileSystem.ReadCacheConfiguration
FileSystem.RootVolumeConfiguration = _FileSystem.RootVolumeConfiguration
FileSystem.SelfManagedActiveDirectoryConfiguration = (
    _FileSystem.SelfManagedActiveDirectoryConfiguration
)
FileSystem.UserAndGroupQuotas = _FileSystem.UserAndGroupQuotas
FileSystem.WindowsConfiguration = _FileSystem.WindowsConfiguration
S3AccessPointAttachment.FileSystemGID = _S3AccessPointAttachment.FileSystemGID
S3AccessPointAttachment.OntapFileSystemIdentity = (
    _S3AccessPointAttachment.OntapFileSystemIdentity
)
S3AccessPointAttachment.OntapUnixFileSystemUser = (
    _S3AccessPointAttachment.OntapUnixFileSystemUser
)
S3AccessPointAttachment.OntapWindowsFileSystemUser = (
    _S3AccessPointAttachment.OntapWindowsFileSystemUser
)
S3AccessPointAttachment.OpenZFSFileSystemIdentity = (
    _S3AccessPointAttachment.OpenZFSFileSystemIdentity
)
S3AccessPointAttachment.OpenZFSPosixFileSystemUser = (
    _S3AccessPointAttachment.OpenZFSPosixFileSystemUser
)
S3AccessPointAttachment.S3AccessPoint = _S3AccessPointAttachment.S3AccessPoint
S3AccessPointAttachment.S3AccessPointOntapConfiguration = (
    _S3AccessPointAttachment.S3AccessPointOntapConfiguration
)
S3AccessPointAttachment.S3AccessPointOpenZFSConfiguration = (
    _S3AccessPointAttachment.S3AccessPointOpenZFSConfiguration
)
S3AccessPointAttachment.S3AccessPointVpcConfiguration = (
    _S3AccessPointAttachment.S3AccessPointVpcConfiguration
)
StorageVirtualMachine.ActiveDirectoryConfiguration = (
    _StorageVirtualMachine.ActiveDirectoryConfiguration
)
StorageVirtualMachine.SelfManagedActiveDirectoryConfiguration = (
    _StorageVirtualMachine.SelfManagedActiveDirectoryConfiguration
)
Volume.AggregateConfiguration = _Volume.AggregateConfiguration
Volume.AutocommitPeriod = _Volume.AutocommitPeriod
Volume.ClientConfigurations = _Volume.ClientConfigurations
Volume.NfsExports = _Volume.NfsExports
Volume.OntapConfiguration = _Volume.OntapConfiguration
Volume.OpenZFSConfiguration = _Volume.OpenZFSConfiguration
Volume.OriginSnapshot = _Volume.OriginSnapshot
Volume.RetentionPeriod = _Volume.RetentionPeriod
Volume.SnaplockConfiguration = _Volume.SnaplockConfiguration
Volume.SnaplockRetentionPeriod = _Volume.SnaplockRetentionPeriod
Volume.TieringPolicy = _Volume.TieringPolicy
Volume.UserAndGroupQuotas = _Volume.UserAndGroupQuotas
