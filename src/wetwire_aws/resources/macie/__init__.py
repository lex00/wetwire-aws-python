...
class AllowList(CloudFormationResource):
    ...
    criteria: DslValue[_AllowList.Criteria] | None = None
    ...
    Criteria = PropertyTypeDescriptor(_AllowList.Criteria, "Criteria")
    S3WordsList = PropertyTypeDescriptor(_AllowList.S3WordsList, "S3WordsList")
...
class CustomDataIdentifier(CloudFormationResource):
    ...
    description: DslValue[str] | None = None
    ignore_words: list[DslValue[str]] = field(default_factory=list)
    keywords: list[DslValue[str]] = field(default_factory=list)
    maximum_match_distance: DslValue[int] | None = None
    tags: list[DslValue[Tag]] = field(default_factory=list)
...
class FindingsFilter(CloudFormationResource):
    ...
    finding_criteria: DslValue[_FindingsFilter.FindingCriteria] | None = None
    name: DslValue[str] | None = None
    action: DslValue[str] | None = None
    description: DslValue[str] | None = None
    position: DslValue[int] | None = None
    tags: list[DslValue[Tag]] = field(default_factory=list)
    ...
    # PropertyType descriptors for nested GetAtt support
    CriterionAdditionalProperties = PropertyTypeDescriptor(
        _FindingsFilter.CriterionAdditionalProperties, "CriterionAdditionalProperties"
    )
    FindingCriteria = PropertyTypeDescriptor(
