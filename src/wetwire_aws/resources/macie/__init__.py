...
AllowList.Criteria = PropertyTypeDescriptor(_AllowList.Criteria, "Criteria")
AllowList.S3WordsList = PropertyTypeDescriptor(_AllowList.S3WordsList, "S3WordsList")
FindingsFilter.CriterionAdditionalProperties = PropertyTypeDescriptor(
    _FindingsFilter.CriterionAdditionalProperties, "CriterionAdditionalProperties"
)
FindingsFilter.FindingCriteria = PropertyTypeDescriptor(
    _FindingsFilter.FindingCriteria, "FindingCriteria"
)
