...
class EnabledBaseline(CloudFormationResource):
    ...
    baseline_identifier: DslValue[str] | None = None
    baseline_version: DslValue[str] | None = None
    target_identifier: DslValue[str] | None = None
    parameters: list[DslValue[_EnabledBaseline.Parameter]] = field(default_factory=list)
    ...
    Parameter = PropertyTypeDescriptor(_EnabledBaseline.Parameter, "Parameter")
...
class EnabledControl(CloudFormationResource):
    ...
    control_identifier: DslValue[str] | None = None
    target_identifier: DslValue[str] | None = None
    parameters: list[DslValue[_EnabledControl.EnabledControlParameter]] = field(
        default_factory=list
    )
    tags: list[DslValue[Tag]] = field(default_factory=list)

    # PropertyType descriptors for nested GetAtt support
    EnabledControlParameter = PropertyTypeDescriptor(
...
class LandingZone(CloudFormationResource):
    ...
    remediation_types: list[DslValue[str]] = field(default_factory=list)
    tags: list[DslValue[Tag]] = field(default_factory=list)
