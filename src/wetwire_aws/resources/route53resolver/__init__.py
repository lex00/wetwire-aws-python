...
FirewallRuleGroup.FirewallRule = PropertyTypeDescriptor(
    _FirewallRuleGroup.FirewallRule, "FirewallRule"
)
ResolverEndpoint.IpAddressRequest = PropertyTypeDescriptor(
    _ResolverEndpoint.IpAddressRequest, "IpAddressRequest"
)
ResolverRule.TargetAddress = PropertyTypeDescriptor(
    _ResolverRule.TargetAddress, "TargetAddress"
)
