...
class Group(CloudFormationResource):
    ...
    policies: list[DslValue[_Group.Policy]] = field(default_factory=list)

    # GetAtt attributes
    ARN: ClassVar[str] = "Arn"

    # PropertyType descriptors for nested GetAtt support
    Policy = PropertyTypeDescriptor(_Group.Policy, "Policy")
...
class ManagedPolicy(CloudFormationResource):
    ...
    managed_policy_name: DslValue[str] | None = None
    path: DslValue[str] | None = None
    roles: list[DslValue[str]] = field(default_factory=list)
...
class OIDCProvider(CloudFormationResource):
    ...
    client_id_list: list[DslValue[str]] = field(default_factory=list)
    tags: list[DslValue[Tag]] = field(default_factory=list)
    thumbprint_list: list[DslValue[str]] = field(default_factory=list)
...
class Role(CloudFormationResource):
    ...
    description: DslValue[str] | None = None
    managed_policy_arns: list[DslValue[str]] = field(default_factory=list)
    max_session_duration: DslValue[int] | None = None
    path: DslValue[str] | None = None
    permissions_boundary: DslValue[str] | None = None
    policies: list[DslValue[_Role.Policy]] = field(default_factory=list)
    ...
    # PropertyType descriptors for nested GetAtt support
    Policy = PropertyTypeDescriptor(_Role.Policy, "Policy")
...
class SAMLProvider(CloudFormationResource):
    ...
    add_private_key: DslValue[str] | None = None
    assertion_encryption_mode: DslValue[str] | None = None
    name: DslValue[str] | None = None
    private_key_list: list[DslValue[_SAMLProvider.SAMLPrivateKey]] = field(
        default_factory=list
    )
    remove_private_key: DslValue[str] | None = None
    ...
    # PropertyType descriptors for nested GetAtt support
    SAMLPrivateKey = PropertyTypeDescriptor(
...
class ServerCertificate(CloudFormationResource):
    ...
    certificate_body: DslValue[str] | None = None
    certificate_chain: DslValue[str] | None = None
    path: DslValue[str] | None = None
    private_key: DslValue[str] | None = None
    server_certificate_name: DslValue[str] | None = None
    tags: list[DslValue[Tag]] = field(default_factory=list)
...
class ServiceLinkedRole(CloudFormationResource):
    ...
    aws_service_name: DslValue[str] | None = None
    custom_suffix: DslValue[str] | None = None
    description: DslValue[str] | None = None
...
class User(CloudFormationResource):
    ...
    groups: list[DslValue[str]] = field(default_factory=list)
    login_profile: DslValue[_User.LoginProfile] | None = None
    managed_policy_arns: list[DslValue[str]] = field(default_factory=list)
    path: DslValue[str] | None = None
    permissions_boundary: DslValue[str] | None = None
    policies: list[DslValue[_User.Policy]] = field(default_factory=list)
    tags: list[DslValue[Tag]] = field(default_factory=list)
    user_name: DslValue[str] | None = None
    ...
    # PropertyType descriptors for nested GetAtt support
    LoginProfile = PropertyTypeDescriptor(_User.LoginProfile, "LoginProfile")
    Policy = PropertyTypeDescriptor(_User.Policy, "Policy")
...
class VirtualMFADevice(CloudFormationResource):
    ...
    path: DslValue[str] | None = None
    tags: list[DslValue[Tag]] = field(default_factory=list)
    virtual_mfa_device_name: DslValue[str] | None = None
