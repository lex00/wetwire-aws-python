...
class Permission(CloudFormationResource):
    ...
    policy_template: DslValue[dict[str, Any]] | None = None
...
class ResourceShare(CloudFormationResource):
    ...
    name: DslValue[str] | None = None
    allow_external_principals: DslValue[bool] | None = None
    permission_arns: list[DslValue[str]] = field(default_factory=list)
    principals: list[DslValue[str]] = field(default_factory=list)
    resource_arns: list[DslValue[str]] = field(default_factory=list)
    sources: list[DslValue[str]] = field(default_factory=list)
    tags: list[DslValue[Tag]] = field(default_factory=list)
