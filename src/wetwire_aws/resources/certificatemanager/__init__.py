...
class Account(CloudFormationResource):
    ...
    expiry_events_configuration: DslValue[_Account.ExpiryEventsConfiguration] | None = (
        None
    )
    ...
    ExpiryEventsConfiguration = PropertyTypeDescriptor(
...
class Certificate(CloudFormationResource):
    ...
    certificate_export: DslValue[str] | None = None
    certificate_transparency_logging_preference: DslValue[str] | None = None
    domain_validation_options: list[DslValue[_Certificate.DomainValidationOption]] = (
    ...
    validation_method: DslValue[str] | None = None

    # PropertyType descriptors for nested GetAtt support
    DomainValidationOption = PropertyTypeDescriptor(
