...
Account.ExpiryEventsConfiguration = PropertyTypeDescriptor(
    _Account.ExpiryEventsConfiguration, "ExpiryEventsConfiguration"
)
Certificate.DomainValidationOption = PropertyTypeDescriptor(
    _Certificate.DomainValidationOption, "DomainValidationOption"
)
